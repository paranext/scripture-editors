...
import { forwardRef as Mn, useState as de, useRef as re, useCallback as he, useEffect as j, useMemo as Fe, memo as Wm, createContext as uf, useContext as df, Children as Hm, isValidElement as Gm, cloneElement as Jm, useImperativeHandle as fc, useLayoutEffect as os } from "react";
import { assertSafeKey as Ve, isValidBookCode as Ym, MARKER_OBJECT_PROPS as Xm, USJ_VERSION as yr, USJ_TYPE as br, isUsjTextContentLocation as Qm, indexesFromUsjJsonPath as ff, isUsjAttributeKeyLocation as Zm, isUsjAttributeMarkerLocation as ey, isUsjClosingAttributeMarkerLocation as ty, isUsjMarkerLocation as ry, isUsjClosingMarkerLocation as ny, isUsjPropertyValueLocation as iy, getUsjDocumentLocationTypeName as sy, usjJsonPathFromIndexes as on, EMPTY_USJ as pf } from "@eten-tech-foundation/scripture-utilities";
import { $applyNodeReplacement as je, $parseSerializedNode as so, DecoratorNode as as, ElementNode as Yt, isHTMLElement as En, createState as oo, $getState as ne, $setState as gt, $isRangeSelection as O, $isElementNode as F, $isTextNode as v, $getSelection as R, $isNodeSelection as pc, ParagraphNode as hc, TextNode as Ke, $createTextNode as pe, $getCommonAncestor as oy, $isLineBreakNode as cs, NODE_STATE_KEY as ls, $getEditor as us, $hasUpdateTag as ay, $getNodeByKey as se, $getRoot as Ue, $createRangeSelection as gc, $createPoint as eu, $getCharacterOffsets as mc, KEY_DOWN_COMMAND as Cr, COMMAND_PRIORITY_HIGH as Ie, HISTORY_MERGE_TAG as hf, CLICK_COMMAND as ao, COMMAND_PRIORITY_EDITOR as mn, isDOMNode as gf, $getNearestNodeFromDOMNode as ai, CONTROLLED_TEXT_INSERTION_COMMAND as yc, PASTE_COMMAND as mr, COMMAND_PRIORITY_CRITICAL as or, CUT_COMMAND as Xn, DROP_COMMAND as bc, DELETE_CHARACTER_COMMAND as cy, DELETE_WORD_COMMAND as ly, DELETE_LINE_COMMAND as uy, $isDecoratorNode as co, COPY_COMMAND as kc, COMMAND_PRIORITY_LOW as yt, COMMAND_PRIORITY_NORMAL as Gn, SELECTION_CHANGE_COMMAND as lr, getDOMSelection as dy, isSelectionWithinEditor as fy, $createRangeSelectionFromDom as py, $setSelection as Qn, isDOMTextNode as hy, BLUR_COMMAND as Tc, $addUpdateTag as Kr, SKIP_DOM_SELECTION_TAG as gy, CLEAR_HISTORY_COMMAND as my, $getPreviousSelection as yy, $isRootOrShadowRoot as by, CAN_UNDO_COMMAND as ky, CAN_REDO_COMMAND as Ty, DRAGSTART_COMMAND as xy, $createNodeSelection as mf, getDOMSelectionFromTarget as _y, $onUpdate as Cy, KEY_ENTER_COMMAND as yf, LineBreakNode as bf, $copyNode as Sy, FOCUS_COMMAND as vy, $isRootNode as My, KEY_ESCAPE_COMMAND as kf, INSERT_PARAGRAPH_COMMAND as qs, createCommand as Tf, HISTORIC_TAG as xc, UNDO_COMMAND as xf, REDO_COMMAND as _f, CLEAR_EDITOR_COMMAND as Ey } from "lexical";
import { addClassNamesToElement as Dn, removeClassNamesFromElement as Ko, $findMatchingParent as nt, $dfsIterator as Cf, $dfs as ci, mergeRegister as He, registerNestedElementResolver as Sf, $unwrapNode as ka, IS_APPLE as Rs } from "@lexical/utils";
...
import { ContentEditable as Mf } from "@lexical/react/LexicalContentEditable";
import { EditorRefPlugin as Ef } from "@lexical/react/LexicalEditorRefPlugin";
import { LexicalErrorBoundary as Af } from "@lexical/react/LexicalErrorBoundary";
import { HistoryPlugin as Pf } from "@lexical/react/LexicalHistoryPlugin";
...
import { useCollaborationContext as Nf, LexicalCollaboration as By } from "@lexical/react/LexicalCollaborationContext";
...
import { Array as tu, Map as ru, YArrayEvent as Yy } from "yjs";
...
const L = " ", $s = "​", Dt = L, _c = `${L}|`, ar = "p", Ki = "+", wf = "-", Is = "chapter", Ta = "verse", nu = "invalid", Qy = "text-spacing", Zy = "formatted-font", eb = "marker-", qf = "external-usj-mutation", Rf = "selection-change", jr = "cursor-change", xa = "annotation-change", ji = "delta-change", $f = "marker-settle", tb = [
  qf,
  Rf,
  jr,
  xa,
...
class Ee extends Yt {
  ...
  constructor(t = Sc, r, n = !0, i, s, o) {
    super(o), this.__marker = t, this.__caller = r ?? (wi(t) === "crossref" ? wf : Ki), this.__isCollapsed = n, this.__category = i, this.__unknownAttributes = s;
  }
  static getType() {
    return "note";
  }
  ...
  exportDOM(t) {
    ...
    return r && En(r) && (r.setAttribute("data-marker", this.getMarker()), r.classList.add(this.getType(), `usfm_${this.getMarker()}`, this.getIsCollapsed() ? "collapsed" : "expanded"), r.setAttribute("data-caller", this.getCaller()), r.setAttribute("data-note-kind", wi(this.getMarker()))), { element: r };
  }
  exportJSON() {
    return {
      ...super.exportJSON(),
...
function cr(e) {
  const t = Object.hasOwn(_a, e) ? _a[e] : void 0, r = Object.hasOwn(iu, e) ? iu[e] : void 0;
  if (!t)
...
const Ff = "v", zf = "c", cn = "fig", su = "tr", Ca = "esb", Kf = "esbe", Bo = "periph", ou = "alt", au = /^t[hc]([rc]?)(\d+)(?:-(\d+))?$/, lb = {
  "": "start",
  c: "center",
  r: "end"
};
...
function db(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (r || (i = t.length, t += " "), r = !0) : !r && o === $s && s + 1 < e.length && lu(e[s + 1]) || (lu(o) ? (r || (i = t.length, t += o), r = !0) : ub.test(o) && o === n || (t += o, r = !1, i = -1)), (o === `
...
function gb(e, t, r) {
  ...
  for (; i < e.length; ) {
    ...
    if (g === b.Note || g === void 0 && Ee.isValidMarker(l)) {
      const { word: y, next: m } = Vo(e, i);
      i = m, s = l, n.push({ kind: "note", marker: l, caller: y || "+" });
      continue;
    }
    if (g === b.Milestone || g === void 0 && Mc(l)) {
      const y = Cb(e, c, l, i);
      if (y)
    ...
    g === b.Paragraph ? (d(), n.push({ kind: "para", marker: l })) : g === b.Character ? (d(), n.push({ kind: "charOpen", marker: p, isNested: f })) : Ls(p) ? (d(), Ls(p)?.shape === "para" ? n.push({ kind: "para", marker: l }) : n.push({ kind: "charOpen", marker: p, isNested: f })) : (d(), !(r || s !== void 0) || l === Ca || l === Kf ? n.push({ kind: "para", marker: l }) : n.push({ kind: "charOpen", marker: p, isNested: f }));
  }
  return n;
}
const uu = {
...
function _b(e, t, r) {
  ...
  if (i === -1 || e.slice(i, i + 2) !== "\\*")
    return;
  const s = Bi(e.slice(n + 1, i), r, uo(r));
  if (s)
...
function Cb(e, t, r, n) {
  ...
  let a;
  if (o >= 0 && (a = Bi(s.slice(o + 1), r, uo(r)), !a && s.slice(o + 1).trim() !== "")) {
    const u = s.slice(0, o);
    return {
...
function Sr(e, t) {
  ...
  const g = () => {
    ...
    s && (o.length > a && (m(a), o.length = a), a = 0, te || (s.closed = "false"), s = void 0);
  }, S = () => {
    c = void 0, l = void 0;
  }, P = (te, E, Y) => {
    k();
...
`) && (w = w.slice(0, -1)), M = void 0, X();
    ...
    $.value && (te.content = [ir($.value)]), g().push(te), o.push({ object: te }), $ = void 0;
  }, ee = (te, E) => {
...
`) && (E = E.slice(0, -1));
    const Y = E.indexOf("|"), le = Y >= 0 ? Bi(E.slice(Y + 1), Bo) : void 0, W = Y >= 0 ? E.slice(0, Y) : E;
    if (Y >= 0 && (!le || W && le[ou])) {
      ee(Bo, E);
      return;
    }
  ...
  const en = () => {
    if (we) {
      if (we.shape === "para")
        ...
        we.value && (te.content = [ir(we.value)]), g().push(te), o.push({ object: te });
      }
      we = void 0;
    }
  }, hr = gb(e, t?.getMarker ?? cr, n);
  for (let te = 0; te < hr.length; te++) {
    const E = hr[te];
    if ($) {
      if (E.kind === "text") {
        $.value += E.text;
      ...
      if ($.shape === "char" && E.kind === "end" && E.marker.replace(/^\+/, "") === $.marker) {
        if ($.value.trim() === "") {
          g().push({ type: "char", marker: $.marker, content: [] }), $ = void 0, J();
          continue;
        }
      ...
      if ($.shape === "para" && (E.kind === "para" || E.kind === "chapter")) {
        ...
        Y === "" ? (ee($.marker), $ = void 0) : (Object.assign($.target, { [$.attrName]: ir(Y) }), $ = void 0);
      } else {
...
`) && ($.value = $.value.slice(0, -1)), $.shape === "para" ? Oe() : Me(), te--;
    ...
    if (we) {
      ...
      if (E.kind === "end" && E.marker.replace(/^\+/, "") === cn) {
        const Y = we.value.indexOf("|"), le = Y >= 0 ? Bi(we.value.slice(Y + 1), cn) : void 0;
        if (le) {
          const W = {};
...
`)) {
      ...
      case "verse": {
        _(!1);
        const Y = { type: "verse", marker: Ff, number: E.number };
        y(Y), M = Y;
        break;
      }
      case "chapter": {
      ...
      case "charOpen": {
        ...
        const Y = g(), le = { type: "char", marker: E.marker, content: [] };
        Y.push(le), o.push({ object: le });
        break;
      }
      case "end": {
        const Y = E.marker.replace(/^\+/, ""), le = s ? a : 0, W = o.findLastIndex((ke, Nt) => Nt >= le && ke.object.marker === Y);
        W >= 0 ? (Sb(o[W].object), m(W + 1), o.length = W) : s && s.marker === Y ? _(!0) : (m(le), o.length = le, y({ type: "unmatched", marker: `${E.marker}*` }));
        break;
      }
      case "milestone":
  ...
  if (be && Qt(!0), we && en(), $)
    if ($.shape === "para") {
      ...
      te === "" ? ee($.marker) : Object.assign($.target, { [$.attrName]: ir(te) }), $ = void 0;
    } else
      $.value.endsWith(`
...
function Sb(e) {
  ...
  if (n < 0)
    return;
  const i = t.slice(n).map((c) => typeof c == "string" ? c : "//").join(""), s = i.indexOf("|"), o = Bi(i.slice(s + 1), e.marker ?? "");
  if (!o)
    return;
  const a = i.slice(0, s);
...
const bn = oo("cid", {
  ...
  parse: (e) => typeof e == "string" ? e : void 0
}), dr = "marker-trailing-space", Bf = 1, vb = "marker", Ec = oo("isGutterMarker", {
  parse: (e) => e === !0
});
class vr extends as {
  __textType;
...
const zr = "internal-comment", Nb = [zr], Wf = Object.freeze({}), Sa = Object.freeze({}), va = Object.freeze({}), Ma = Object.freeze({}), Ea = Object.freeze({}), Ob = 1, Un = /* @__PURE__ */ new Map(), Ci = /* @__PURE__ */ new Map(), Fn = /* @__PURE__ */ new Map(), zn = /* @__PURE__ */ new Map();
class Ze extends Yt {
  __typedIDs;
  __typedOnClicks;
  __typedOnRemoves;
  ...
  constructor(t = Wf, r, n, i, s, o) {
    super(o), this.__typedIDs = Cs(t), this.__typedOnClicks = Wo(r), this.__typedOnRemoves = Ho(n), this.__typedOnMouseEnters = Go(i), this.__typedOnMouseLeaves = Jo(s), this.pruneTypedOnClicks(), this.pruneTypedOnRemoves(), this.pruneTypedOnMouseEnters(), this.pruneTypedOnMouseLeaves(), this.syncTypedOnClicksToRegistry(), this.syncTypedOnRemovesToRegistry(), this.syncTypedOnMouseEntersToRegistry(), this.syncTypedOnMouseLeavesToRegistry();
  }
  static getType() {
    return "typed-mark";
  }
  static clone(t) {
    const r = Cs(t.__typedIDs), n = Wo(t.__typedOnClicks), i = Ho(t.__typedOnRemoves), s = Go(t.__typedOnMouseEnters), o = Jo(t.__typedOnMouseLeaves);
  ...
  updateDOM(t, r, n) {
    ...
    for (const s of i) {
      ...
      for (const g of o)
        p.has(g) || Ko(r, ln("annotationId", g));
      for (const g of a)
        f.has(g) || Dn(r, ln("annotationId", g));
    }
    return !1;
  }
  updateFromJSON(t) {
  ...
  syncTypedOnRemovesToRegistry() {
    if (!this.__typedOnRemoves || Object.keys(this.__typedOnRemoves).length === 0) {
      Ci.delete(this.getKey()), this.__typedOnRemoves && Object.keys(this.__typedOnRemoves).length === 0 && (this.__typedOnRemoves = void 0);
      return;
    }
    Ci.set(this.getKey(), this.__typedOnRemoves);
  }
  ...
  mergeWithAdjacentTypedMarks() {
    ...
    for (; Ce(t) && fu(t.getTypedIDs(), this.getTypedIDs()); )
      this.mergeWithPreviousTypedMark(t), t = this.getPreviousSibling();
    let r = this.getNextSibling();
    for (; Ce(r) && fu(this.getTypedIDs(), r.getTypedIDs()); )
  ...
  for (let m = 0; m < u; m++) {
    ...
    if (P !== null) {
      if (P && P.is(g))
        continue;
      const A = P.getParent();
      (A == null || !A.is(g)) && (y = void 0), g = A, y === void 0 && (y = Vi(), y.addID(t, r, n, i, s, o), P.insertBefore(y)), y.append(P);
    } else
      g = void 0, y = void 0;
  }
...
const Db = ["type", "marker", "content"], Aa = "unknown", Jf = 1, Ub = /* @__PURE__ */ new Set(["optbreak", "ref"]);
class An extends Yt {
  __tag;
  __marker;
  __unknownAttributes;
...
function op(e) {
  return e ? e.classList.contains(Is) && e.tagName.toLowerCase() === sp : !1;
}
function ds(e) {
...
function sk(e) {
  ...
  e.setTextContent(t.replaceAll(Zn, ""));
}
function fs(e) {
  return e.length > 0 && e.includes(Zn) && e.replaceAll(Zn, "") === "";
}
function Oc(e) {
...
function ak(e) {
  return Tt(e) || $e(e) || D(e) || ds(e) || ur(e) || Be(e) || ae(e) || K(e) || Pe(e) || Le(e);
}
function gp(e) {
...
function yp(e) {
  return Ic(e) || Vf(e) && e.textType === "marker" || ei(e) && hk(e) === "attribute" ? "" : ei(e) && e.text !== L ? e.text : Jb(e) ? e.children.map((t) => yp(t)).join("") : "";
}
function gk(e) {
  return e.map((r) => yp(r)).filter((r) => r.length > 0).join(" ").trim();
}
function Mt(e) {
  return " " + e + L;
}
...
function bp(e) {
  return N(e) || Mr(e) || v(e) && ne(e, oe) === "attribute" ? "" : v(e) ? e.getTextContent() : F(e) ? e.getChildren().map((t) => bp(t)).join("") : "";
}
function Mr(e) {
...
function $c(e) {
  if (!e)
    return !1;
  if (cs(e) || N(e) || Mr(e) || Ht(e) && e.getTextType() === "attribute")
    return !0;
  if (v(e)) {
    const t = ne(e, oe);
    if (t === dr || t === "attribute")
...
function Ak(e) {
  ...
  return !t || !Object.keys(t).some((n) => n !== "closed") ? !1 : Ii(e) === void 0 && Pp(e) === void 0;
}
function Pp(e) {
...
function ps(e, t) {
  ...
  Lc(e) && (r = e, e = e.getNextSibling()), v(e) && ne(e, oe) === "attribute" && (n = e, e = e.getNextSibling()), N(e) && e.getMarkerSyntax() === "closing" && e.getMarker() === t && Xr(e) && (i = e), { opener: r, value: n, closer: i, wrapper: s };
}
function Ji(e) {
  const t = e.getChildren();
  let r = 0;
...
function mo(e) {
  ...
  // opener is at rest, not byte damage.
  Lc(s) && (t = s, s = s.getNextSibling()), v(s) && ne(s, oe) === "attribute" && (r = s, s = s.getNextSibling()), N(s) && s.getMarkerSyntax() === "selfClosing" && Xr(s) && (n = s), { opening: t, attribute: r, closing: n, wrapper: i };
}
function Dc(e) {
  return D(ho(e));
}
...
function Uc(e, t) {
  ...
  if (r !== null)
    return N(r) ? Pa(r, t) === !0 ? "spacer" : void 0 : yo(r) ? r.getTextContent().startsWith(L) ? void 0 : "prefix" : "spacer";
}
function Ok(e) {
  if (e.isAttached()) {
    for (const t of e.getChildren())
      if (N(t) && Uc(t, e) !== void 0)
...
function Lp(e) {
  return e.isAttached() ? e.getChildren().some((t) => N(t) && Uc(t, e) !== void 0 && $p(t, e)) : !1;
}
...
function Tu(e) {
  return {
    ...
    scanPieces: (t) => Pe(t) ? Gi(Xo(t, e), e) : Ar,
...
const jk = {
  ...
  scanPieces: (e) => D(e) ? { value: Pp(e) } : Ar,
  graceSite: (e, t) => {
    if (!D(e) || t.value)
      return !1;
    const r = Ii(e);
  ...
  byteFormat: {
    ...
    glyphs: "none",
    insertRunBefore: (e) => D(e) ? Ii(e) : void 0
  }
};
function Fp(e) {
  if (N(e))
...
const Wk = {
  ...
  ownerOf: (e) => {
    ...
    const t = e.getParent();
    return ze(t) ? t.getRunKind() === "cat" && K(t.getParent()) ? t.getParent() ?? void 0 : void 0 : Fp(e) ? Vk(e) : void 0;
  },
  expectedPieces: (e) => {
  ...
  byteFormat: {
    ...
    glyphMarker: () => "cat",
    closerSyntax: "closing",
    insertRunAfter: (e) => K(e) ? Ji(e) : void 0
  }
};
function Hk(e) {
...
function xu(e) {
  const t = (r) => $e(r) ? e === "ca" ? go(r) : wp(r) : void 0;
  return {
    kind: e,
    ...
    scanPieces: (r) => $e(r) ? e === "ca" ? Op(r) : qp(r) : Ar,
    graceSite: (r, n) => {
      if (!$e(r))
        return !1;
...
const Xk = {
  ...
  ownerOf: (e) => {
    const t = ze(e) ? e.getRunKind() === "milestone" ? e : void 0 : ze(e.getParent()) ? e.getParent() : zp(e) ? e : void 0;
  ...
  expectedPieces: (e) => {
    if (!Be(e))
      return bt;
    const t = Ap(e.getSid(), e.getEid(), e.getUnknownAttributes(), e.getAttributeOrder()), r = sr(t, uo(e.getMarker()));
...
}, Qk = Up("optbreak", void 0, void 0).opening, Zk = {
  kind: "optbreak",
...
class Pr extends Ke {
  __marker;
  constructor(t = "", r) {
    super(Li(t), r), this.__marker = t, this.__mode = 1;
  }
  static getType() {
    return "unmatched";
  }
  ...
  setMarker(t) {
    if (this.__marker === t)
      return this;
    const r = this.getWritable();
    return r.__marker = t, r.__text = Li(t), r;
  }
  getMarker() {
    return this.getLatest().__marker;
  }
  createDOM(t) {
    const r = super.createDOM(t);
    return r.setAttribute("data-marker", this.__marker), r.classList.add(nu), r.title = _u(this.__marker), r;
  }
  updateDOM(t, r, n) {
    const i = super.updateDOM(t, r, n);
    return t.__marker !== this.__marker && (r.setAttribute("data-marker", this.__marker), r.title = _u(this.__marker)), i;
  }
  exportDOM() {
...
function Bp(e) {
  return e.getTextContent() === Li(e.getMarker());
}
function _u(e) {
...
const Vp = "table", Na = "immutable-table", Wp = 1, sT = ["type", "marker", "content"];
class Nn extends Yt {
  __unknownAttributes;
  constructor(t, r) {
...
const Gp = "table:row", Cu = "immutable-table-row", Jp = 1, Oa = "tr", cT = ["type", "marker", "content"];
class ui extends Yt {
  __marker;
  __unknownAttributes;
...
function lT(e, t) {
  return je(new ui(e, t));
}
const Yp = "table:cell", Su = "immutable-table-cell", Xp = 1, wa = "tc1", uT = [
  "type",
  "marker",
  "align",
  "colspan",
...
function TT(e, t, r) {
  const { renderGlyphs: n, closeImplicitSpans: i = !1 } = r, s = Qp(t), o = [];
...
function _T(e) {
  return Yn.get(us())?.has(e.getKey()) ?? !1;
}
function CT(e) {
  Yn.get(us())?.add(e.getKey());
}
function ST(e) {
...
function MT(e, t, r, n) {
  return !r.wantsRun || Ra(n) || ay(ji) ? !1 : us().getEditorState().read(() => {
    const i = se(t.getKey());
...
function PT(e, t, r, n) {
  ...
  if (i === "owner-children") {
    ...
    if (!f || n.valueText === void 0)
      return;
    v(r.value) ? r.value.setTextContent(n.valueText) : f.insertBefore(Eu(n.valueText));
    return;
  }
  const l = AT(e, t, r);
  if (!l || s === "none" || !o || !a)
  ...
  let d = r.value;
  n.valueText === void 0 ? (d?.remove(), d = void 0) : v(d) ? Bc(d.getTextContent(), n.valueText) && d.setTextContent(n.valueText) : (d = Eu(n.valueText), u.insertAfter(d)), a !== "none" && !r.closer && (d ?? u).insertAfter(ot(a === "selfClosing" ? "" : o(t), a));
}
function Qi(e, t) {
...
function NT(e, t, r) {
  Qi(e, t), t.isAttached() && hs(e, t) && r.add(t.getKey());
}
function eh(e) {
  if (!v(e))
    return !1;
...
function rh(e) {
  ...
  const t = e.isBackward(), r = t ? e.focus : e.anchor, n = t ? e.anchor : e.focus, i = [Au(r), Au(n)], s = Nu(r, "next"), o = Nu(n, "previous");
  return !s && !o ? !1 : e.isCollapsed() || e.isBackward() !== t ? (Pu(r, i[0]), Pu(n, i[1]), !1) : !0;
}
const js = "verse-block", nh = 1, $T = "verse-block";
class fi extends Yt {
  ...
  createDOM() {
    ...
    return t.classList.add($T), Ou(t, this.__number), t;
  }
  updateDOM(t, r) {
...
const ih = "v", sh = 1, zT = "verse-selected";
class xt extends as {
  __marker;
  __number;
  __showMarker;
  ...
  __unknownAttributes;
  constructor(t = "", r = !1, n, i, s, o, a) {
    super(a), this.__marker = ih, this.__number = t, this.__showMarker = r, this.__sid = n, this.__altnumber = i, this.__pubnumber = s, this.__unknownAttributes = o;
  }
  static getType() {
...
function BT(e) {
  return (e?.getAttribute("data-marker") ?? void 0) === ih;
}
function On(e) {
...
function xo(e) {
  return F(e) ? Zi(e) ? e.getChildren().flatMap(xo) : e.getChildren() : [];
}
function GT(e, t) {
...
function lh(e, t = "delta-doc") {
  ...
  for (const c of r) {
    ...
    if (vt(l) && (i.includes(l) || i.push(l)), uh(l, t)) {
      if (l.getKey() === o)
        return n;
...
function px(e, t = "delta-doc") {
  ...
  for (const o of r) {
    ...
    if (vt(a) && (i.includes(a) || i.push(a)), uh(a, t)) {
      if (n === e)
        return a;
...
function uh(e, t) {
  return K(e) || Le(e) ? !0 : t === "apply" && F(e) && At(e);
}
function dh(e) {
  const t = e.getParent();
...
function bx(e) {
  return !Kp(e) && Yc(e, "delta-doc") === e.getTextContentSize();
}
function Yc(e, t) {
  if (At(e))
    return 1;
  if (v(e)) {
    ...
    (Oc(e) || dh(e) || ne(e, oe) === "marker-trailing-space" || // An attribute value keyed by its own state, not by ancestry: a CHAR span's run is a direct
...
function Xc(e, t) {
  ...
  for (let c = 0; c < n.length; c++) {
    const l = n[c].node;
    r.push(...Uu(l, c, n, i, s, o, a));
  }
  for (const c of i)
    r.push(...Uu(c, n.length, n, i, s, o, a));
  return r;
}
function kx() {
  return Xc();
...
function Tx(e, t, r) {
  if (!e.isInline()) {
    const n = r.pop();
    Tt(n) ? t.push(vx(n)) : ae(n) ? t.push(Ex(n)) : ur(n) && t.push({ insert: es });
  }
...
function xx(e, t, r, n, i) {
  ...
  if (K(s) && s.getFirstChild() === e)
    return;
  const o = Gt(e) !== void 0;
  if (N(e) && (o || dh(e) || La(e) || Kp(e)) || ne(e, oe) === "marker-trailing-space")
    return;
  let a = e.getTextContent();
  if (fs(a))
    return;
  const c = e.getPreviousSibling();
  if (K(s) && N(c) && c === s.getFirstChild() && a === Mt(s.getCaller()))
    return;
  const l = D(s) ? s : void 0, u = l?.getFirstChild();
  o && l && N(u) && c === u && a.startsWith(L) && (a = a.slice(1));
  const d = a.startsWith(_c) || ne(e, oe) === "attribute" || La(e), f = !!l && a === Dt && l.getChildrenSize() === 1, p = _o(e, n), g = p ? r.filter((k) => p.children.includes(k)) : r, y = Da(e, g);
  if (y.insert = a, p) {
    if (!a || a === L || d)
      return;
...
function vx(e) {
  ...
  return Zr(t, e), { insert: es, attributes: { book: t } };
}
function Mx(e) {
...
function Ex(e) {
  ...
  return Zr(t, e), { insert: es, attributes: { para: t } };
}
function Ax(e) {
...
class Vt extends as {
  ...
  decorate(t) {
    ...
    return C("button", { onClick: o, title: this.__previewText, "data-caller-id": a, children: this.__caller === Ki && i ? (
...
function Zc(e) {
  ...
  let { end: r } = e;
  r ??= t;
  let [n, i] = Fu(t), [s, o] = Fu(r);
  if (!n || !s || i === void 0 || o === void 0)
    return;
  [n, i] = zu(n, i), [s, o] = zu(s, o);
  const a = gc();
  return a.anchor = eu(n.getKey(), i, Ku(n)), a.focus = eu(s.getKey(), o, Ku(s)), a;
}
function hh() {
  if (gh())
    return;
...
function Si(e) {
  const t = new RegExp(/^(\$(?:\.content\[\d+\])*)(?:\.|$|\[)/).exec(e), r = t ? t[1] : e, n = ff(r);
  let i = Ue();
  for (const s of n) {
    if (!i || !F(i))
      return;
...
function mh(e, t, r, n, i, s, o) {
  ...
  if (c === void 0)
    return;
  const l = t ?? (wi(e) === "crossref" ? s.defaultCrossRefCaller ?? "-" : s.defaultFootnoteCaller ?? "+"), u = yh(e, l, c, i, s, void 0, void 0);
  return Hx(u, a, i), u;
}
function el(e) {
  return e !== "expanded";
...
function Hx(e, t, r) {
  ...
  e.setIsCollapsed(n), t.isCollapsed() || dk(t), rh(t);
  const i = Wx(t);
...
function yh(e, t, r, n, i, s, o) {
  ...
  if (d && l.append(d), n?.markerMode === "editable" && !c)
    ...
    if (t === "")
      ...
      i?.noteCallerOnClick && (k = i.noteCallerOnClick), p = Qc(l.__caller, m, k), l.append(p, g(), ...y);
    }
  }
...
function Bu(e) {
  ...
  let a = "";
  for (const c of t)
    if (!(K(c) || _t(c) || Xx(c)) && !N(c) && !Qr(c) && ne(c, oe) !== "attribute") {
      if (ge(c)) {
        a += `\\+fv ${c.getNumber()}\\+fv*`;
        continue;
      }
...
function kh({ isOpen: e = !1, children: t }) {
  const r = re(null), { coords: n, placement: i } = t_({ isOpen: e, floatingBoxRef: r }), s = Fe(() => n ? typeof t == "function" ? t : () => t : () => null, [t, n]);
  return hn(
...
function i_({ children: e, menuItems: t, onSelectOption: r, ...n }) {
  const i = n_(t, r);
  return C(Th.Provider, { value: i, children: C("div", { ...n, children: e }) });
}
const xh = Mn(({ index: e, children: t, onMouseEnter: r, onClick: n, ...i }, s) => {
...
function s_({ children: e, autoIndex: t = !0, ...r }) {
  const n = re(null), { state: { activeIndex: i, menuItems: s } } = tl(), o = Fe(() => s ? typeof e == "function" ? e : () => e : () => null, [e, s]), a = Fe(() => {
    const c = o(s);
    return t ? Hm.map(c, (l, u) => Gm(l) && l.type === xh && l.props.index === void 0 ? Jm(l, { index: u }) : l) : c;
  }, [o, t, s]);
  return j(() => {
    if (n.current) {
...
const o_ = (e, t, r) => Ps(e, r).toLowerCase().includes(t.toLowerCase()), Vu = (e) => Object.keys(e).find((t) => typeof e[t] == "string") || "", Ps = (e, t) => {
  const r = e[t];
...
function a_(e) {
  ...
  let u, d;
  i ? (d = i, u = r.length > 0 ? Vu(r[0]) : "") : (u = n || (r.length > 0 ? Vu(r[0]) : ""), d = (g, y) => o_(g, y, u));
  const f = s || u, p = /* @__PURE__ */ new Map();
  return r.filter((g) => {
    try {
      return d(g, t);
    } catch (y) {
      return console.warn("Error filtering item:", g, y), !1;
    }
  }).sort((g, y) => {
    const m = (S) => (p.has(S) || p.set(S, Ps(S, f).toLowerCase()), p.get(S) ?? ""), k = a ? Ps(g, f) : m(g), _ = a ? Ps(y, f) : m(y);
    for (const S of c)
      switch (S) {
        case "exact":
          if (k === l && _ !== l)
...
function _h(e) {
  const { options: t, onSelectOption: r, onClose: n, inverse: i, query: s, menuOpenKey: o, onFilterChange: a, passthroughKeys: c } = e, [l] = ce(), u = s !== void 0, [d, f] = de(""), p = u ? s ?? "" : d, g = c_({ query: p, items: t, filterBy: "name" }), y = (m) => {
    n?.(), r ? r(m) : m.action(l);
  };
  return j(() => {
    a?.(p, g);
  }, [a, p, g]), j(() => l.registerCommand(Cr, (m) => {
    if (u || c?.includes(m.key) || f_.includes(m.key))
      return !1;
  ...
  }, Ie), [l, u, p, o, n, c]), xe(ea.Root, { className: `autocomplete-menu-container ${i ? "inverse" : ""}`, menuItems: g, onSelectOption: (m) => y(m), children: [!u && C("input", { value: p, type: "text", disabled: !0 }), C(d_, {}), C(ea.Options, { className: "autocomplete-menu-options", autoIndex: !1, children: (m) => m.map((_, S) => xe(ea.Option, { index: S, children: [C("span", { className: "label", children: _.label ?? _.name }), C("span", { className: "description", children: _.description })] }, _.name)) })] });
}
function p_({ trigger: e, items: t }) {
  ...
  }), [r]), t && C(kh, { isOpen: n, children: ({ placement: o }) => C(_h, { options: t, onClose: () => i(!1), inverse: o === "top-start", menuOpenKey: e }) });
}
...
function g_(e, t) {
  j(() => {
    ...
    return He(Sf(e, Ze, (n) => Vi(n.getTypedIDs(), n.getTypedOnClicks(), n.getTypedOnRemoves(), n.getTypedOnMouseEnters(), n.getTypedOnMouseLeaves()), (n, i) => {
      const s = n.getTypedOnClicks(), o = n.getTypedOnRemoves(), a = n.getTypedOnMouseEnters(), c = n.getTypedOnMouseLeaves();
      for (const [l, u] of Object.entries(n.getTypedIDs()))
        u.forEach((d) => {
          const f = s[l]?.[d], p = o[l]?.[d], g = a[l]?.[d], y = c[l]?.[d];
          i.addID(l, d, f, p, g, y);
        });
        ...
        for (const [i, s] of n) {
          ...
          for (const [c, l] of Object.entries(a))
            if (!Ze.isReservedType(c))
              for (const u of l) {
                let d = t.get(Di(c, u));
                a[c] = l, r.set(i, a), s === "destroyed" ? d !== void 0 && (d.delete(i), d.size === 0 && t.delete(Di(c, u))) : (d === void 0 && (d = /* @__PURE__ */ new Set(), t.set(Di(c, u), d)), d.has(i) || d.add(i));
              }
        }
      });
...
const m_ = Mn(function({ logger: t }, r) {
  ...
  g_(n, i);
  const s = (o, a, c) => {
    const l = Array.from(c ?? i.get(Di(o, a)) ?? []);
    if (l.length !== 0)
      for (const u of l) {
        const d = se(u);
  ...
  return os(() => {
    if (n)
      return i.registerUpdateListener((s) => {
        ...
        e && u.has(hf) && !u.has($f) || r.some((f) => u.has(f)) || l.isEmpty())
          return;
        const d = k_(i, s);
  ...
  return e.getEditorState().read(() => {
    ...
    if (t.size === 1 && v(s) && !o && bx(s)) {
      ...
      if (a !== void 0) {
        const c = r.read(() => {
          const d = se(i);
          return new Oi([v(d) ? Da(d) : { insert: "" }]);
        }), l = new Oi([Da(s)]), u = new Oi(a > 0 ? [{ retain: a }] : []);
        n = n.concat(u).concat(c.diff(l));
      }
    } else {
      const a = Du(r), c = Du(e.getEditorState());
      n = a.diff(c);
    }
  }), n.ops;
}
const rl = "formatted", Ch = "unformatted", Sh = "paragraph-structure", vh = "standard", Mh = "block-verse", T_ = {
  [rl]: "Formatted",
  [Ch]: "Unformatted",
  [Sh]: "Paragraph Structure",
  [vh]: "Standard",
  [Mh]: "Block Verse"
};
function pi(e) {
...
function mP(e) {
  if (!e)
    return;
  const t = Wu(e);
  return Object.keys(T_).find((r) => wt(Wu(Eh(r)), t));
}
const __ = {
...
function C_(e) {
  if (e)
    return ts(e) ? xt : e.markerMode === "editable" ? dt : xt;
}
function ts(e) {
      ...
      if (e < o + d && o < e + t) {
        ...
        if (g > 0) {
          ...
          if (m && k) {
            ...
            [y] = _.splitText(g);
          } else m ? [, y] = u.splitText(f) : k && ([y] = u.splitText(g));
          if (Wr(r)) {
            const _ = y.getParent();
            if (D(_)) {
              const S = r.char;
              ...
              if (A && Array.isArray(S) && S.length > 1) {
                const B = pe("");
                y.replace(B);
                const M = typeof r.segment == "string" ? r.segment : void 0, w = hi(S.slice(1), n, y, M);
                let $ = B;
                for (const X of w)
                  $.insertAfter(X), $ = X;
                B.remove(), qt(r, y);
...
function Hu(e, t, r, n) {
  const i = typeof t.segment == "string" ? t.segment : void 0, s = hi(t.char, r, e, i), o = s.find(D);
  if (!o) {
...
function Gu(e, t) {
  for (const r of Object.keys(t)) {
    ...
    typeof n == "string" && (We(e) || ge(e) || Be(e) || K(e) || Le(e) ? e.setUnknownAttributes({
      ...e.getUnknownAttributes() ?? {},
      [r]: n
    }) : (Tt(e) || ae(e) || D(e)) && (r === "style" && ae(e) ? Ah(e, n) : r === "style" && D(e) ? Ua(e, n) : r === "code" && Tt(e) ? e.setCode(n) : e.setUnknownAttributes({
      ...e.getUnknownAttributes() ?? {},
      [r]: n
    })), r === "segment" && gt(e, Br, () => n));
  }
        ...
        if (c.length > 0 && u === 0)
          ...
          if (p && Se(p)) {
            ...
            for (const k of y) {
              ...
              xr(k) ? g += k.getTextContentSize() : At(k) && (g += 1), i = _;
            }
...
function N_(e, t, r, n, i) {
  ...
  if (Array.isArray(a)) {
    if (o) {
      const g = a[0];
      g && kn(g, o) ? (a = a.slice(1), a.length === 1 && (a = a[0])) : o = void 0;
    }
  ...
  for (const [g, y] of Object.entries(r))
    g !== "char" && g !== "segment" && typeof y == "string" && (f[g] = y);
...
function O_(e, t, r, n, i) {
  let s;
  return Ur("chapter", t) ? s = q_(t.insert.chapter, r) : Ur("verse", t) ? s = R_(t.insert.verse, r) : Ur("ms", t) ? s = $_(t.insert.ms) : Ur("note", t) ? s = Oh(t, r, n, i) : Ur("unknown", t) ? s = wh(t, r, n, i) : Ur("unmatched", t) && (s = L_(t.insert.unmatched, r)), s ? Ph(e, s, i) : (i?.error(`$insertEmbedAtCurrentIndex: Cannot create LexicalNode for embed object: ${JSON.stringify(t.insert)}`), !1);
}
function Ju(e, t, r, n) {
  let i;
  sl(t) ? i = Nh(t.para, r) : U_(t) && (i = w_(t.book)), i ??= Bt();
    ...
    if (xr(d)) {
      ...
      if (e >= c && e <= c + f) {
        ...
        if (ae(p) && (o || a)) {
          ...
          const g = e - c, [y] = g > 0 ? d.splitText(g) : [void 0];
          let m, k = y?.getPreviousSibling();
          for (; k; ) {
            const _ = k;
            k = k.getPreviousSibling(), m ? m.insertBefore(_) : s.append(_), m = _;
          }
...
function Oh(e, t, r, n) {
  ...
  for (const y of c?.ops ?? [])
    if (typeof y.insert == "string")
      if (Wr(y.attributes)) {
        const m = hi(y.attributes.char, t, pe(y.insert), void 0, qh(y.attributes.char, p), !1, t.markerMode === "editable");
        p.push(...m);
      } else
        p.push(pe(y.insert));
  return yh(s, o, p, t, r, f, u).setCategory(a).setUnknownAttributes(l);
}
function wh(e, t, r, n) {
...
function I_(e, t, r, n) {
  ...
  for (const s of e) {
    if (typeof s.insert == "string") {
      if (Wr(s.attributes)) {
        const o = pe(s.insert), a = hi(s.attributes.char, t, o, void 0, qh(s.attributes.char, i));
        i.push(...a);
      } else
        i.push(pe(s.insert));
      continue;
...
function hi(e, t, r, n, i, s = !1, o = !1) {
  ...
  if (Array.isArray(e)) {
    ...
    const d = c.reduceRight((f, p, g) => {
      const y = Tr(p.style, De(p, Ws));
      if (typeof p.cid == "string" && gt(y, bn, () => p.cid), n && g === c.length - 1 && gt(y, Br, () => n), f)
        if (D(f)) {
          const m = f.getMarker(), k = [];
          ra(m, k, t, !0), k.forEach((S) => y.append(S)), y.append(f);
          const _ = [];
          ta(f, _, t, !0), _.forEach((S) => y.append(S));
        } else
          y.append(f);
      return y;
    }, r);
...
function K_() {
  const [e] = ce();
  return j(() => e.registerCommand(ao, (t) => (j_(t), !1), mn), [e]), null;
}
function j_(e) {
  if (B_(e.target))
    return;
...
function B_(e) {
  ...
  if (!Ab(t))
    return !1;
  const r = t.getParent();
  return r ? Se(r) ? gi(r) : (Jt(r, t.getIndexWithinParent() + 1), !0) : !1;
}
function V_(e) {
  if (!e.isCollapsed())
    return !1;
  ...
  return !Mr(n) && !On(n) ? !1 : gi(r);
}
function W_() {
  const [e] = ce();
  return j(() => {
    const t = (r) => r instanceof KeyboardEvent && !H_(r) || !$h() ? !1 : (r instanceof Event && r.preventDefault(), !0);
    return He(
...
function Hr(e) {
  return nt(e, (t) => Le(t) || Hp(t)) ?? void 0;
}
function $h() {
  const e = R();
  ...
  j(() => {
    ...
    const r = (n) => {
      ...
      if (s && o && (n.key === "ArrowLeft" || n.key === "ArrowRight") && n.shiftKey && !n.altKey && !n.ctrlKey && !n.metaKey) {
        const u = Yu(o), d = sC(i, Xu(u, n.key) ? "next" : "previous");
      ...
      if (n.key !== "ArrowLeft" && n.key !== "ArrowRight" || !o)
        return !1;
      const a = Yu(o), c = n.shiftKey || n.altKey || n.ctrlKey || n.metaKey;
      let l = !1;
      return Xu(a, n.key) ? l = !c && ed(i, "next") || !c && eC(i) || cC(i) || !c && s && Zu(i, "next") : Z_(a, n.key) && (l = !c && ed(i, "previous") || !c && tC(i) || lC(i, t) || !c && s && Zu(i, "previous")), l && n.preventDefault(), l;
    };
...
function tC(e) {
  ...
  if (t.type === "text") {
    ...
    return !n || !r.is(n.getFirstChild()) ? !1 : t.offset === 1 ? (r.select(0, 0), !0) : t.offset !== 0 ? !1 : Qu(n);
  }
  if (t.offset === 0) {
    const n = za(r);
    return n ? Qu(n) : !1;
...
function Dh(e) {
  return cs(e) ? !0 : K(e) ? e.getIsCollapsed() === !0 : v(e) ? (e.isToken() || Lh(e)) && e.getTextContentSize() > 0 : co(e) ? !Be(e) : !1;
}
function ii(e, t, r) {
...
function vo(e, t, r) {
  for (let n = e; n; ) {
    if (Dh(n))
      return n;
    if (F(n)) {
      n = (t === "next" ? n.getFirstChild() : n.getLastChild()) ?? ii(n, t, r);
      continue;
    }
    if (ni(n))
      return n;
...
function ol(e, t, r, n, i) {
  return r === "element" && F(e) ? e.getChildAtIndex(n === "next" ? t : t - 1) ?? ii(e, n, i) : r === "text" && Dh(e) && (n === "next" ? t < e.getTextContentSize() : t > 0) ? e : ii(e, n, i);
}
function na(e, t) {
...
function oC(e, t, r) {
  const n = e.getNode();
  if (e.type === "text" && ni(n) && (t === "next" ? e.offset < n.getTextContentSize() : e.offset > 0))
    return !1;
...
function cC(e) {
  const t = e.anchor.getNode(), r = gp(e);
  if (K(r) && !N(r.getFirstChild())) {
    ...
    if (r.getIsCollapsed()) {
      if (r.is(r.getParent()?.getLastChild())) {
        ...
        return i && !(Se(i) && gi(i)) && i.selectStart(), !0;
      }
...
function fC(e) {
  j(() => {
    ...
    return He(
      ...
      e.registerNodeTransform(me, Ip),
      // Self-healing attribute display run: re-derive the `|…` run from unknownAttributes
      // whenever a span is dirtied — heals remote collab updates (delta-apply only calls
      // setUnknownAttributes) and structure surgery. $syncDisplayRun (displayRunSync.utils.ts,
      // `shared`), driven here with the char descriptor from displayRunRegistry.ts (`shared`).
      e.registerNodeTransform(me, (t) => Qi(Tn("char"), t)),
...
function Kh(e) {
  const t = () => !zh();
  return He(e.registerCommand(kc, t, yt), e.registerCommand(Xn, t, yt));
}
const al = (e) => {
...
function _C({ options: e } = {}) {
  ...
  return os(() => {
    ...
    if (!d)
      return;
    const { width: f, height: p } = d.getBoundingClientRect(), g = Math.max(0, Math.min(i.x, globalThis.innerWidth - f)), y = Math.max(0, Math.min(i.y, globalThis.innerHeight - p));
    d.style.left = `${g}px`, d.style.top = `${y}px`, d.style.visibility = "visible";
...
function MC(e) {
  if (R())
    return;
  const t = e.getRootElement(), r = dy(t?.ownerDocument.defaultView ?? null);
  if (!r || r.rangeCount === 0)
    return;
  const { anchorNode: n, anchorOffset: i, focusNode: s, focusOffset: o } = r;
  if (!n || !s || !fy(e, n, s))
    return;
  const a = { node: n, offset: i }, c = { node: s, offset: o };
  let l, u;
  if (r.isCollapsed)
    l = sa(e, a, SC(a)), u = l;
  else {
    const g = CC(r.getRangeAt(0), a);
    l = sa(e, a, g ? "before" : "after"), u = sa(e, c, g ? "after" : "before");
  }
  if (!l && !u)
    return;
  const d = l ?? a, f = u ?? c;
  r.setBaseAndExtent(d.node, d.offset, f.node, f.offset);
  const p = py(r, e);
  p && Qn(p);
}
function EC() {
  const [e] = ce();
  return j(() => e.registerCommand(lr, () => (MC(e), !1), or), [e]), null;
}
function AC() {
  const [e] = ce();
...
function jh(e) {
  const [t] = ce(), r = re(void 0), n = he((i) => {
    const s = R(), o = O(s) && s.isCollapsed() ? s.anchor.key : void 0, a = r.current, c = rd(a);
...
function RC(e, t) {
  ...
  j(() => {
    let o = i;
    (!o || o.length <= 0) && (o = Kx), r.current !== o && (r.current = o, nd("note-callers", o, t));
  }, [t, i]), j(() => {
    let o = s;
    (!o || o.length <= 0) && (o = jx), n.current !== o && (n.current = o, nd("cross-ref-callers", o, t));
  }, [t, s]);
}
function $C(e, t, r, n) {
  j(() => {
...
function IC(e, t) {
  ...
  if (!r.some((i) => _t(i)) && t?.markerMode !== "editable" && e.getCaller() !== "" && e.remove(), r.length > 0) {
    const i = r[0];
    v(i) && !N(i) && i.getTextContent() !== Mt(e.getCaller()) && e.insertBefore(i);
  }
}
function LC(e) {
...
function FC(e, t) {
  for (const [r, n] of e) {
    ...
    const i = t.read(() => {
      ...
      return _t(o) && K(a) && a.getCaller() === Ki;
...
function zC(e, t, r, n) {
  ...
  if (t.current) {
    ...
    if (a)
      ...
      c && !c.getIsCollapsed() && (n?.debug("Cursor moved away from NoteNode, collapsing it"), Mi(e, t.current, n)), t.current = void 0;
    }
  }
  if (s.offset === 0) {
    ...
    if (K(a)) {
      ...
      const c = a.getKey();
      a.getIsCollapsed() ? t.current = c : t.current = void 0, Mi(e, c, n);
    }
  }
  ...
  if (Se(o)) {
    ...
    if (On(c) && K(a)) {
      ...
      const l = a.getKey();
      a.getIsCollapsed() ? t.current = l : t.current = void 0, Mi(e, l, n);
    }
  }
  return !1;
}
...
function KC(e) {
  ...
  if (K(i) && v(s)) {
    e.preventDefault();
    const o = gc();
    o.anchor.set(s.getKey(), 0, "text"), o.focus.set(s.getKey(), n.offset, "text"), Qn(o);
  }
}
function nd(e, t, r) {
...
function YC(e, t) {
  ...
  return r && id(e, r, i), n && id(t, n, !i), !0;
}
function id(e, t, r) {
  const n = t.getParent();
...
function XC() {
  ...
  }, [e]), j(() => e.registerCommand(lr, () => (JC(t.current) && Kr(jr), !1), mn), [e]), null;
}
function QC({ onChange: e }) {
  const [t] = ce();
  return j(() => t.registerCommand(lr, () => {
    const r = hh();
    return e?.(r), !1;
  }, yt), [t, e]), null;
}
...
function tS(e, t) {
  Ia(t, e.getKey()) && ch(e.getFirstChild()), !(!ae(e) || e.getMarker() !== "b" || e.isEmpty() || !t.getEditorState().read(() => {
    const i = se(e.getKey());
...
function Bh({ onStateChange: e }) {
  const [t] = ce(), [r, n] = de(t), i = re(!1), s = re(!1), o = re(void 0), a = re(void 0), c = he(() => {
    ...
    if (O(l)) {
      ...
      p === null && (p = d.getTopLevelElementOrThrow()), Zi(p) && (p = nt(d, ae) ?? p);
      const g = p.getKey(), y = r.getElementByKey(g), m = uk(d, f);
      if (m && tx(m) && (u = m.getMarker()), y !== null && (ae(p) || Tt(p) || ds(p))) {
  ...
  return j(() => t.registerCommand(lr, (l, u) => (c(), n(u), !1), or), [t, c]), j(() => He(r.registerUpdateListener(({ editorState: l }) => {
    l.read(() => {
      c();
    });
...
function dl(e) {
  return O(e) && e.isCollapsed() && e.anchor.type === "element" || !O(e) && !pc(e) ? !1 : e.getNodes().some((t) => ge(t));
}
function Wh(e) {
  if (!O(e) || !e.isCollapsed())
    return !1;
...
function nS(e, t) {
  ...
  switch (t) {
    case "insertParagraph":
      return !0;
    case "deleteBackward":
      return Wh(e) && Xs(e, "backward") || sd(e, "backward");
    case "deleteForward":
      return Hh(e) && Xs(e, "forward") || sd(e, "forward");
    case "insertText":
      return !1;
  }
}
...
const Yh = Object.entries, cd = Object.setPrototypeOf, fS = Object.isFrozen, pS = Object.getPrototypeOf, hS = Object.getOwnPropertyDescriptor;
...
const jn = Ge(Array.prototype.forEach), gS = Ge(Array.prototype.lastIndexOf), ld = Ge(Array.prototype.pop), Bn = Ge(Array.prototype.push), mS = Ge(Array.prototype.splice), Fr = Array.isArray, qi = Ge(String.prototype.toLowerCase), oa = Ge(String.prototype.toString), ud = Ge(String.prototype.match), Ei = Ge(String.prototype.replace), dd = Ge(String.prototype.indexOf), yS = Ge(String.prototype.trim), bS = Ge(Number.prototype.toString), kS = Ge(Boolean.prototype.toString), fd = typeof BigInt > "u" ? null : Ge(BigInt.prototype.toString), pd = typeof Symbol > "u" ? null : Ge(Symbol.prototype.toString), Xe = Ge(Object.prototype.hasOwnProperty), Ai = Ge(Object.prototype.toString), Ye = Ge(RegExp.prototype.test), dn = TS(TypeError);
function Ge(e) {
  return function(t) {
...
function Qh() {
  ...
  const u = e.DOMParser, d = e.trustedTypes, f = a.prototype, p = zt(f, "cloneNode"), g = zt(f, "remove"), y = zt(f, "nextSibling"), m = zt(f, "childNodes"), k = zt(f, "parentNode"), _ = zt(f, "shadowRoot"), S = zt(f, "attributes"), P = o && o.prototype ? zt(o.prototype, "nodeType") : null, A = o && o.prototype ? zt(o.prototype, "nodeName") : null, B = o && o.prototype ? zt(o.prototype, "ownerDocument") : null;
  ...
  const Me = function() {
    ...
    return X || ($ = DS(d, i), X = !0), $;
  }, Qt = r, we = Qt.implementation, en = Qt.createNodeIterator, hr = Qt.createDocumentFragment, Ct = Qt.getElementsByTagName, te = n.importNode;
  let E = xd();
  ...
  let ct = bd, ue = null;
  const qn = fe({}, [...hd, ...aa, ...ca, ...la, ...gd]);
  let ye = null;
  const bi = fe({}, [...md, ...ua, ...yd, ...Ss]);
  ...
  let qr = !0, tn = !0, ki = !1, gs = !0, Ft = !1, q = !0, z = !1, G = !1, Q = null, _e = null, lt = !1, Ot = !1, rn = !1, nn = !1, Il = !0, Ll = !1;
  const Dl = "user-content-";
  let Oo = !0, ms = !1, Rn = {}, tr = null;
  const wo = fe({}, [
    "annotation-xml",
    "audio",
    "colgroup",
  ...
  let qo = null;
  const zl = fe({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), ys = "http://www.w3.org/1998/Math/MathML", bs = "http://www.w3.org/2000/svg", rr = "http://www.w3.org/1999/xhtml";
  let $n = rr, Ro = !1, $o = null;
  const Nm = fe({}, [ys, bs, rr], oa), Kl = et(["mi", "mo", "mn", "ms", "mtext"]);
  let Io = fe({}, Kl);
  ...
  let qe = null, In = null;
  const Rm = r.createElement("form"), Bl = function(h) {
    return h instanceof RegExp || h instanceof Function;
  }, Do = function() {
    let h = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (In && In === h)
      return;
    (!h || typeof h != "object") && (h = {}), h = st(h), Ti = // eslint-disable-next-line unicorn/prefer-includes
    wm.indexOf(h.PARSER_MEDIA_TYPE) === -1 ? qm : h.PARSER_MEDIA_TYPE, qe = Ti === "application/xhtml+xml" ? oa : qi, ue = Lr(h, "ALLOWED_TAGS", qn, {
      transform: qe
    }), ye = Lr(h, "ALLOWED_ATTR", bi, {
      transform: qe
      ...
      transform: qe
    }), Rn = Xe(h, "USE_PROFILES") ? h.USE_PROFILES && typeof h.USE_PROFILES == "object" ? st(h.USE_PROFILES) : h.USE_PROFILES : !1, qr = h.ALLOW_ARIA_ATTR !== !1, tn = h.ALLOW_DATA_ATTR !== !1, ki = h.ALLOW_UNKNOWN_PROTOCOLS || !1, gs = h.ALLOW_SELF_CLOSE_IN_ATTR !== !1, Ft = h.SAFE_FOR_TEMPLATES || !1, q = h.SAFE_FOR_XML !== !1, z = h.WHOLE_DOCUMENT || !1, Ot = h.RETURN_DOM || !1, rn = h.RETURN_DOM_FRAGMENT || !1, nn = h.RETURN_TRUSTED_TYPE || !1, lt = h.FORCE_BODY || !1, Il = h.SANITIZE_DOM !== !1, Ll = h.SANITIZE_NAMED_PROPS || !1, Oo = h.KEEP_CONTENT !== !1, ms = h.IN_PLACE || !1, ct = CS(h.ALLOWED_URI_REGEXP) ? h.ALLOWED_URI_REGEXP : bd, $n = typeof h.NAMESPACE == "string" ? h.NAMESPACE : rr, Io = Xe(h, "MATHML_TEXT_INTEGRATION_POINTS") && h.MATHML_TEXT_INTEGRATION_POINTS && typeof h.MATHML_TEXT_INTEGRATION_POINTS == "object" ? st(h.MATHML_TEXT_INTEGRATION_POINTS) : fe({}, Kl), Lo = Xe(h, "HTML_INTEGRATION_POINTS") && h.HTML_INTEGRATION_POINTS && typeof h.HTML_INTEGRATION_POINTS == "object" ? st(h.HTML_INTEGRATION_POINTS) : fe({}, jl);
    ...
    et && et(h), In = h;
  }, Vl = fe({}, [...aa, ...ca, ...SS]), Wl = fe({}, [...la, ...vS]), $m = function(h, x, I) {
    return x.namespaceURI === rr ? h === "svg" : x.namespaceURI === ys ? h === "svg" && (I === "annotation-xml" || Io[I]) : !!Vl[h];
  }, Im = function(h, x, I) {
    return x.namespaceURI === rr ? h === "math" : x.namespaceURI === bs ? h === "math" && Lo[I] : !!Wl[h];
  }, Lm = function(h, x, I) {
    return x.namespaceURI === bs && !Lo[I] || x.namespaceURI === ys && !Io[I] ? !1 : !Wl[h] && (Om[h] || !Vl[h]);
  }, Dm = function(h) {
    let x = k(h);
    (!x || !x.tagName) && (x = {
      namespaceURI: $n,
    ...
    const I = qi(h.tagName), V = qi(x.tagName);
    return $o[h.namespaceURI] ? h.namespaceURI === bs ? $m(I, x, V) : h.namespaceURI === ys ? Im(I, x, V) : h.namespaceURI === rr ? Lm(I, x, V) : !!(Ti === "application/xhtml+xml" && $o[h.namespaceURI]) : !1;
  }, Rr = function(h) {
    Bn(t.removed, {
      element: h
    });
    ...
    for (; x.length > 0; ) {
      ...
      if (V === St.processingInstruction || V === St.comment && Ye(Td, I.data)) {
        try {
          g(I);
        } catch {
        }
    ...
    Ti === "application/xhtml+xml" && $n === rr && (h = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + h + "</body></html>");
    const V = M ? ee(h) : h;
    if ($n === rr)
      try {
        x = new u().parseFromString(V, Ti);
      } catch {
      }
    ...
    return h && I && H.insertBefore(r.createTextNode(I), H.childNodes[0] || null), $n === rr ? Ct.call(x, z ? "html" : "body")[0] : z ? x.documentElement : H;
  }, Gl = function(h) {
    ...
    return h = Ei(h, Y, " "), h = Ei(h, le, " "), h = Ei(h, W, " "), h;
  }, Uo = function(h) {
    var x;
    h.normalize();
  ...
  const zm = function(h, x) {
    return !!(q && h.hasChildNodes() && !_i(h.firstElementChild) && Ye(kd, h.textContent) && Ye(kd, h.innerHTML) || q && h.namespaceURI === rr && x === "style" && _i(h.firstElementChild) || h.nodeType === St.processingInstruction || q && h.nodeType === St.comment && Ye(Td, h.data));
  }, Km = function(h, x, I) {
    ...
    if (ue = Jl(E.uponSanitizeElement, ue, qn, Q), nr(E.uponSanitizeElement, h, {
      tagName: I,
      allowedTags: ue
    }), h !== x && k(h) === null)
      return ms && xi(h), !0;
    ...
    if (wr[x] || q && x === "patchsrc" || q && x === "for" && h !== "label" && h !== "output" || Il && (x === "id" || x === "name") && (I in r || I in Rm))
      return !1;
    ...
    if (!(tn && Ye(ke, x))) {
      if (!(qr && Ye(Nt, x))) {
        if (V) {
          if (!qo[x]) {
            if (!Ye(ct, Ei(I, Zt, ""))) {
              if (!((x === "src" || x === "xlink:href" || x === "href") && h !== "script" && dd(I, "data:") === 0 && Ul[h])) {
                if (!(ki && !Ye(Nr, Ei(I, Zt, "")))) {
                  if (I)
                    return !1;
                }
    ...
    return !0;
  }, jm = fe({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]), Ql = function(h) {
    return !jm[qi(h)] && Ye(Je, h);
  }, Bm = function(h, x, I, V) {
    ...
    try {
      I ? h.setAttributeNS(I, x, V) : h.setAttribute(x, V), xs(h) ? Rr(h) : ld(t.removed);
    } catch {
      sn(x, h);
    }
  }, Zl = function(h) {
    ...
    if (!x || xs(h))
      return;
    ye = Jl(E.uponSanitizeAttribute, ye, bi, _e);
    const I = {
      attrName: "",
      attrValue: "",
      keepAttr: !0,
    ...
    for (; V--; ) {
      ...
      if (I.attrName = ht, I.attrValue = ut, I.keepAttr = !0, I.forceKeepAttr = void 0, nr(E.uponSanitizeAttribute, h, I), ut = I.attrValue, Ll && (ht === "id" || ht === "name") && dd(ut, Dl) !== 0 && (sn(Te, h), ut = Dl + ut), q && Ye(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, ut)) {
        sn(Te, h);
        continue;
      }
      if (ht === "attributename" && ud(ut, "href")) {
        sn(Te, h);
        continue;
      }
      if (!I.forceKeepAttr) {
    ...
    for (nr(E.beforeSanitizeShadowDOM, h, null); x = I.nextNode(); )
      if (nr(E.uponSanitizeShadowNode, x, null), Yl(x, h), Zl(x), Ln(x.content) && _s(x.content), (P ? P(x) : x.nodeType) === St.element) {
        const H = _(x);
        Ln(H) && (Fo(H), _s(H));
      }
    ...
    for (; x.length > 0; ) {
      ...
      const V = I.node, ie = (P ? P(V) : V.nodeType) === St.element, Te = m(V);
      if (Te)
  ...
  return t.sanitize = function(U) {
    ...
    if (Ro = !U, Ro && (U = "<!-->"), typeof U != "string" && !_i(U) && (U = _S(U), typeof U != "string"))
    ...
    const ie = ms && typeof U != "string" && _i(U);
    if (ie) {
      Fm(U);
      ...
      x = Hl("<!---->"), I = x.ownerDocument.importNode(U, !0), I.nodeType === St.element && I.nodeName === "BODY" || I.nodeName === "HTML" ? x = I : x.appendChild(I), Fo(I);
    else {
    ...
    try {
      const pt = Gl(Te);
      for (; V = pt.nextNode(); )
        Yl(V, Te), Zl(V), Ln(V.content) && _s(V.content);
    } catch (pt) {
      throw ie && (ks(U), jn(t.removed, (ht) => {
        ht.element && xi(ht.element);
      })), pt;
    }
    if (ie)
    ...
    return z && ue["!doctype"] && x.ownerDocument && x.ownerDocument.doctype && x.ownerDocument.doctype.name && Ye(qS, x.ownerDocument.doctype.name) && (Re = "<!DOCTYPE " + x.ownerDocument.doctype.name + `>
  ...
  return j(() => {
    ...
    const o = (p) => {
      ...
      if (k) {
        if (k.kind === "verse") {
          const _ = mf();
          _.add(k.node.getKey()), Qn(_);
        } else {
          const _ = gc();
          _.anchor.set(k.node.getKey(), 0, "element"), _.focus.set(k.node.getKey(), k.node.getChildrenSize(), "element"), Qn(_);
        }
        return s({ key: k.node.getKey(), kind: k.kind, intent: p }), g.preventDefault(), !0;
      }
      if (O(y) && !y.isCollapsed() && dl(y)) {
      ...
      if (e !== "protected")
        return !1;
      const g = R();
      return !g || !Ns(g) ? !1 : (p instanceof Event && p.preventDefault(), !0);
    }, l = (p, g) => {
      if (!p)
        return !1;
      const y = US.sanitize(p), m = new DOMParser().parseFromString(y, "text/html"), k = oS(zy(t, m)), _ = R();
      return O(_) && _.insertNodes(k), g.preventDefault(), !0;
    }, u = (p) => {
      if (e !== "protected")
        return !1;
      const g = R();
      return g && Ns(g) ? (p.preventDefault(), !0) : l(p.clipboardData?.getData("text/html"), p);
    }, d = (p) => {
      if (e !== "protected")
        return !1;
      const g = R();
      return g && Ns(g) ? (p.preventDefault(), !0) : l(p.dataTransfer?.getData("text/html"), p);
    }, f = () => {
      const p = r.current;
    ...
    return He(t.registerCommand(Cr, o, Ie), t.registerCommand(Xn, c, Ie), t.registerCommand(mr, u, Ie), t.registerCommand(xy, c, Ie), t.registerCommand(bc, d, Ie), t.registerCommand(yc, c, Ie), t.registerUpdateListener(f));
  }, [t, e, s]), j(() => {
...
function KS(e, t) {
  j(() => (_d(e, t), e.registerUpdateListener(({ dirtyElements: r }) => {
    r.size > 0 && _d(e, t);
  })), [e, t]);
}
function _d(e, t) {
...
function GS() {
  const e = R();
  if (!(!O(e) || !e.isCollapsed()))
    return fl(HS(e.anchor));
}
function JS(e) {
  const t = R();
  let r;
  return O(t) ? t.isCollapsed() && (r = t.anchor.getNode()) : t || (r = Zh(e.target)), r ? fl(nt(r, K)) : void 0;
}
function Zh(e) {
...
function rv({ trigger: e, harness: t }) {
  const [r] = ce(), [n, i] = de(void 0), s = re({ query: "", options: [] }), o = re(0), a = he((f, p, g) => {
  ...
  j(() => He(r.registerCommand(Cr, (f) => {
    if (n) {
      ...
      if (n.hasTextSelection) {
        const y = n.items.find((m) => m.marker === g);
...
function ov(e, t) {
  return e.isEmpty() ? pf : rg(e.toJSON(), t);
}
function rg(e, t) {
...
function pv(e, t) {
  ...
  return Ae({ type: Vp, ...r, content: t });
}
function hv(e, t) {
  const { marker: r, unknownAttributes: n } = e;
  return Ae({ type: Gp, marker: r, ...n, content: t });
}
function gv(e, t) {
...
function Kt(e, t, r, n = !1) {
  ...
  return e.forEach((a, c) => {
    const l = a, u = a, d = a, f = a, p = a, g = a, y = a, m = a;
    switch (a.type) {
      case Ut.getType():
        i.push(
          av(
      ...
      case Ze.getType():
        if (s = Kt(
          ...
          if (k)
            ...
            const _ = s.shift();
            _ && (typeof _ == "string" ? Sd(i, _) : i.push(_)), s.length > 0 && i.push(...s);
          }
        }
        break;
      case Wt.getType():
      ...
      case Ke.getType():
        ...
        !fs(g.text) && // A byte test, not (only) the separator state tag, and deliberately so: a lone-NBSP
        ...
        g.text !== L && !g.text.startsWith(_c) && // Char-span attribute display runs (bare `|…`, no NBSP prefix — see
        // usj-editor.adaptor's `addCharAttributes`) carry no NBSP prefix to strip against, so
        // the prefix check above can't catch them; the textType state tag is the only signal.
        g[ls]?.textType !== "attribute" && (!r || g.text !== Mt(r))) {
          let k = yv(g);
          tg(t) && (n && k.startsWith(L) && (k = k.slice(1)), k = iv(nv(k))), Sd(i, k);
        }
        break;
      case An.getType():
        i.push(
...
function Pv(e, t) {
  ...
  ), e.content.length > 0 ? (r = Ja(Dr(e.content)), ts(Z) && (r = Cv(r, kt))) : r = [Md]) : r = [Md], og?.(pl), {
    root: {
      children: r,
      direction: null,
      format: "",
...
function qv(e) {
  let { marker: t } = e;
  t !== Wi && kt?.warn(`Unexpected book marker '${t}'!`), t = t ?? Wi;
  const { code: r } = e;
...
function Rv(e) {
  ...
  return Z?.markerMode === "editable" && Xv(i, s, c), Z?.markerMode === "editable" ? Ae({
    type: Pt.getType(),
    marker: t,
    number: r ?? "",
    sid: n,
...
function $v(e) {
  ...
  const { number: r, sid: n, altnumber: i, pubnumber: s } = e, a = (C_(Z) ?? xt).getType(), c = Z?.markerMode === "editable" ? lp : sh;
  let l, u;
...
function Iv(e, t = [], r = !1) {
  ...
  if (Z?.markerMode === "editable") {
    const [a] = t;
    ei(a) ? a.text = L + a.text : a && t.unshift(at(L));
  }
...
function Lv(e, t = []) {
  ...
  if (pi(Z) && (Z?.markerMode === "editable" ? n.push(
    ...
    const s = n.find(
      (o) => !Ic(o) && !(ei(o) && o.text === L)
    );
    ei(s) && !/^ +$/.test(s.text) && (s.text = s.text.replace(/^ +/, (o) => L.repeat(o.length)));
  }
  const i = De(e, ek);
  return Ae({
    type: Qe.getType(),
...
function Fv(e, t = []) {
  const { marker: r, align: n, colspan: i } = e, s = [], o = r ?? wa, a = Dp(o, i) ?? o;
...
function Kv(e, t) {
  ...
  const { category: n } = e, i = e.caller ?? "*", s = e.closed === "false", o = s ? !1 : el(Z?.noteMode), a = De(e, ob), c = Z?.isNoteShellEditable === !1 ? "token" : "normal";
  let l, u;
...
function Bv(e) {
  ...
  const { sid: r, eid: n } = e, i = De(e, Cc), s = Ep(e);
  return Ae({
    type: Wt.getType(),
    marker: t,
    sid: r,
...
function Vv(e, t) {
  ...
  if (Z?.markerMode === "editable") {
    const { opening: o, attributes: a, closingAttributes: c, closing: l } = Up(
      n,
      r,
      i
    );
...
function Ad(e, t) {
  ...
  const { marker: r, sid: n, eid: i } = e, s = De(e, Cc), o = Ap(
    n,
    i,
    s,
    Ep(e)
...
function Gv(e, t) {
  ...
  if (Z?.markerMode === "editable") {
    const n = [];
    Wa(r, n), Ad(e, n), Ha(r, n, !0), t.push(rs("milestone", n));
  } else
    Wa(r, t), Ad(e, t), Ha(r, t, !0);
}
function Pd(e, t, r) {
  t !== void 0 && r.push(
    rs(e, [
...
function Jv(e, t) {
  Z?.markerMode === "editable" && (Pd("va", e.altnumber, t), Pd("vp", e.pubnumber, t));
}
function Yv(e, t) {
  e !== void 0 && t.push(
    rs("cat", [
    ...
    if (typeof i == "string")
      ...
      switch (i.type) {
        ...
        case Pt.getType():
          ...
          break;
        case dt.getType():
          Z?.hasSpacing || n.push(Mv), n.push($v(i)), Jv(i, n);
          break;
        case me.getType():
          n.push(
        ...
        case Ee.getType():
          ...
          break;
        case Wt.getType():
          Lf(i.marker ?? "") && (r.push(n.length), i.sid !== void 0 && pl?.push(i.sid)), n.push(Bv(i)), Gv(i, n);
          break;
        case Pr.getType():
          n.push(Wv(i.marker ?? ""));
          break;
...
function Ja(e) {
  const t = e.findIndex(
    (n) => Qf(n) || fp(n) || Nc(n) || // A table is a block root in its own right; without this it would be swept into an implied
  ...
  if (t >= 0) {
    ...
    return [...n, i, ...s];
  } else if (e.some((n) => "text" in n && "mode" in n || oh(n)))
    return [ag(e)];
  return e;
}
const Jr = {
  ...
  c: {
    ...
    action: (e) => {
      ...
      return { content: [{
        type: "chapter",
        marker: "c",
        number: `${pp(Ue().getChildren(), t) !== void 0 ? t + 1 : t}`
      }] };
    }
  },
  v: {
...
function Xa(e, t, r, n, i, s, o) {
  ...
  return a ? { action: (l) => {
    l.editor.update(() => {
      const u = R();
      O(u) && (rh(u), l.noteText = u.getTextContent());
      const { content: d, highlightInserted: f } = a.action(l), p = qu(d, Jr, r), g = jo(p);
      if (O(u)) {
        const y = u.anchor.getNode(), m = y.getParent(), k = _n(y), _ = u.anchor.key === u.focus.key;
        if (D(g) && k && _ && !fa(g, o))
          iM(
            u,
            g,
          ...
          if (S) {
            ...
            g.append(...P), S.replace(g), Se(g) && gi(g) || g.selectStart();
          }
        } else if (D(g) && v(y) && !N(y) && D(y.getParent()) && u.isCollapsed() && // NEST-able only. A non-NEST style at a caret inside ANY char span — nested or note-level
        ...
        fa(g, o)) {
          ...
          if (D(S)) {
            ...
            if (P === 0) y.insertBefore(g);
            else if (P >= y.getTextContentSize()) y.insertAfter(g);
            else {
            ...
            const A = g.getChildren().find((B) => v(B) && !N(B));
            A && v(A) ? A.select(
              A.getTextContentSize(),
              A.getTextContentSize()
            ) : g.selectEnd();
          }
        } else if (v(y) && !N(y) && u.isCollapsed() && (K(m) || D(m) && K(m.getParent()))) {
          const S = D(m) ? m : void 0, P = S ? rM(y, u.anchor.offset) : [];
          let B = (S ?? y).insertAfter(g);
          if (Mr(g)) {
            const M = {
              ...r || Co(),
              markerMode: "hidden"
          ...
          F(B) && B.selectEnd();
        } else if (u.insertNodes([g]), bM(g), f) {
          const S = mf();
          S.add(g.getKey()), Qn(S);
        } else if (D(g)) {
          const S = g.getChildren().find((P) => v(P) && !N(P));
          S && v(S) ? S.select(
...
function cM(e, t) {
  ...
  r.forEach((o, a) => {
    ...
    let l = !1;
    s || (s = t(), c.insertBefore(s), l = !0, D(s) && s.getChildren().some((d) => N(d) && d.getMarkerSyntax() === "opening") && nM(s, D(s.getParent()))), uM(c, s, l);
  }), (v(s) || F(s)) && s.selectEnd();
}
function si(e) {
...
function uM(e, t, r) {
  if (v(t)) {
    ...
    if (i)
      ...
      t.append(e);
    Qa(e, t), r && D(t) && t.getChildren().some((s) => N(s)) && v(e) && !N(e) && !e.getTextContent().startsWith(L) && e.setTextContent(L + e.getTextContent());
  }
}
function Qa(e, t) {
...
function hg(e, t, r) {
  if (e.isCollapsed()) {
    ...
    if (wd(f, r), v(u) && u.isAttached()) {
      const g = u.getTextContentSize(), y = Math.max(p - g, 0), m = Math.max(0, Math.min(d - y, g)), k = R();
      O(k) && k.setTextNodeRange(u, m, u, m);
    }
    return !0;
  }
  const n = e.getNodes(), i = e.isBackward(), [s, o] = si(e);
...
function pM(e, t, r) {
  if (e.isCollapsed()) {
    ...
    return !l || l.getMarker() === t ? !1 : (bu(l, t), !0);
  }
  const n = e.getNodes(), [i, s] = si(e);
...
function hM(e, t, r, n) {
  ...
  const u = R();
  if (!O(u)) return l;
  const d = u.isBackward(), [f, p] = si(u), g = yl(
    u.getNodes(),
    f,
    p
  );
  ...
  return y.length > 0 && (mM(y).forEach((m) => yM(m, t)), l = !0), kg(g, d), l;
}
function gM(e, t) {
  return mg(e).some(
    (r) => !gg(r) && !Sn(r, t)
...
function bM(e) {
  ge(e) && (Hc(e.getPreviousSibling()), ch(e.getNextSibling()));
}
const Tg = {
  chapter: "chapter",
  verse: "verse",
...
}, qd = "psc-active-text", vs = "psc-empty-text";
      ...
      t.registerUpdateListener(({ editorState: o }) => {
        const { newActiveKey: a, activeVerseKey: c, emptyKeys: l, nonEmptyKeys: u } = o.read(() => {
          ...
          return Ue().getChildren().forEach((y) => {
            if (!F(y)) return;
            const { emptyKeys: m, nonEmptyKeys: k } = _M(y);
            p.push(...m), g.push(...k);
...
function _M(e) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    for (let a = i + 1; a < t.length; a++) {
      const c = t[a];
      if (ge(c)) break;
      if (!(Ht(c) || N(c)) && c.getTextContent().replaceAll($s, "").trim() !== "") {
        o = !0;
        break;
      }
    }
...
function Ui(e, t, r, n, i) {
  for (const s of e.getChildren())
    if (D(s)) {
      const o = s.getMarker();
      i || SM(s, o, t, r, n), Ui(s, t, r, n, i || o === "xq");
    } else if (ge(s)) {
      if (i) continue;
      const o = kl(r, "v");
      o ? (o.occursUnder ?? []).length > 0 && !(o.occursUnder ?? []).includes(t) && n.set(s.getKey(), "invalid") : n.set(s.getKey(), "unknown");
    } else K(s) ? Ui(s, s.getMarker(), r, n, i) : Le(s) || F(s) && Ui(s, t, r, n, i);
}
function vM(e, t) {
  ...
  for (const o of Ue().getChildren())
    Le(o) || (Tt(o) || We(o) ? i(o, o.getMarker()) : ae(o) ? (i(o, o.getMarker()), s(o) && Ui(o, o.getMarker(), e, r, !1)) : F(o) && s(o) && Ui(o, "p", e, r, !1));
  return r;
}
function MM(e) {
...
function RM(e, t, r) {
  const n = tc(e, t, r), i = Sg(e, t.previousParaMarkers), s = Tl(e, "ip"), a = !t.previousParaMarkers.includes("c") && s && _g(i, s) ? "ip" : "p", c = n.findIndex((u) => u.marker === a);
  if (c <= 0) return n;
...
function Og(e, t) {
  return Be(e) ? !Eo(e.getMarker(), t) : K(e) || Le(e) ? !0 : Pe(e) ? Sl(e) : D(e) ? wg(e, t) : !1;
}
function wg(e, t) {
  if (Ak(e)) return !0;
  const r = e.getMarker();
...
function Ri(e, t, r, n = !1) {
  for (let i = 0; i < e.length; i++) {
    ...
    if (Be(s)) {
      ...
      ), Ri($d(o), t, r), t.push($t)) : t.push(tt), i += o.length;
    } else if (Pe(s)) {
      const o = Cl(e, i);
      Sl(s) ? t.push(tt) : (t.push(
        Rt,
        "verse",
        It(s.getTextContent()),
        JSON.stringify({
      ...
      ), Ri($d(o), t, r), t.push($t)), i += o.length;
    } else N(s) ? t.push(Rt, "marker", It(s.getTextContent()), $t) : Qr(s) ? t.push(Rt, "unmatched", It(s.getTextContent()), $t) : Og(s, r) ? t.push(tt) : cs(s) ? t.push(" ") : v(s) ? t.push(
      It(
        n ? Ag(Fi(s)) : Fi(s)
      )
    ) : D(s) ? (t.push(Rt, "char", JSON.stringify(s.getUnknownAttributes() ?? null)), Ri(s.getChildren(), t, r, !0), t.push($t)) : F(s) ? (t.push(Rt, s.getType()), Ri(s.getChildren(), t, r), t.push($t)) : t.push(tt);
  }
}
function mi(e, t) {
  const r = [];
  return Ri(e, r, t), r.join("");
}
function _r(e) {
  const { children: t } = e;
...
function $i(e, t, r, n = !1) {
  for (let i = 0; i < e.length; i++) {
    ...
    if (o === "ms") {
      ...
      ), $i(u, t, r), t.push($t), i += 1) : t.push(tt);
      continue;
    }
    if (o === "verse") {
      const l = s;
    ...
    if (o === "char") {
      const l = s;
      t.push(Rt, "char", JSON.stringify(l.unknownAttributes ?? null)), $i(_r(s) ?? [], t, r, !0), t.push($t);
      continue;
    }
    if (o === "note" || o === "unknown") {
      t.push(tt);
    ...
    if (o === "unmatched") {
      t.push(Rt, "unmatched", It(oi(s) ?? "")), t.push($t);
      continue;
    }
    const a = oi(s);
    if (a !== void 0) {
    ...
    const c = _r(s);
    c ? (t.push(Rt, o), $i(c, t, r), t.push($t)) : t.push(tt);
  }
}
function Ao(e) {
  let t = 0;
...
function vn(e, t, r, n, i) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (N(a))
      ...
      s();
      const c = _l(e, o);
      Eo(a.getMarker(), r) && Ng(c) ? vn(c, t, r, n) : Pi(t, [a, ...c]), o += c.length;
    } else if (K(a) || Le(a))
      s(), Pi(t, [a]);
    else if (Pe(a)) {
      s();
      const c = Cl(e, o);
      Sl(a) ? Pi(t, [a, ...c]) : (Ms(t, a, It(Fi(a))), vn(c, t, r, n)), o += c.length;
    } else if (D(a))
      s(), wg(a, r) ? Pi(t, [a]) : ns(a, t, r, n, { pending: !0 });
    else if (cs(a))
      s(), Ms(t, a, " ");
    else if (v(a)) {
      ...
      Ms(
        t,
        a,
        c ? It(Fi(a)) : VM(Fi(a), n, l)
      );
    } else F(a) ? ns(a, t, r, n, i) : (s(), Pi(t, [a]));
  }
}
const WM = new RegExp(
  String.raw`^\\\+?([${Xt}]+)(?:\*|[ \u00A0])`
...
function Ml(e, t, r, n = !1) {
  ...
  return ns(e, s, t, r), n ? HM(s, e, t) : s;
}
function Rg(e, t) {
  let r = 0;
  const n = (i) => {
...
function GM(e, t, r) {
  ...
  for (const i of e)
    n.text.length > 0 && (n.text += " "), F(i) && ns(i, n, t, r);
...
function El(e, t, r) {
  const n = Id(e, t, r, !1);
  if (!n) return;
  const i = e.spans.find((o) => o.key === t), s = i && !JM(i) ? Id(e, t, r, !0) : void 0;
...
function XM(e) {
  ...
  if (n < 0) return !1;
  const i = Pe(t) ? Cl(r, n) : Be(t) ? _l(r, n) : [];
...
function Ug(e, t, r = t.pasteRebuildArmed?.current ?? !1) {
  ...
  if (O(l)) {
    ...
    l.isCollapsed() && (a = El(o, l.anchor.key, l.anchor.offset));
  }
  const u = Sr(o.text, {
    getMarker: i
  });
  ...
  f.forEach((m) => g.insertBefore(m)), Rg(f, o.sentinels), e.forEach((m) => m.remove());
  const y = rc(f);
...
function ZM(e, t) {
  ...
  if (O(u)) {
    ...
    u.isCollapsed() && (c = El(o, u.anchor.key, u.anchor.offset));
  }
  const d = Sr(o.text, {
    getMarker: n,
    isNoteContext: !0
  ...
  const p = f.content ?? [], g = zg(p), y = Pg(e, p, g, r);
  if (y.failure !== void 0)
  ...
  if (Ao(y.children) !== o.sentinels.length)
    return i?.warn(
      "[MarkerEdit] Note Tier 2 aborted: serialized sentinel/preserved-node count mismatch"
    ), !1;
  const m = e.getCategory() !== g;
  if (m && e.setCategory(g), yi(y.children, n) === mi(a, n))
    return i?.debug("[MarkerEdit] Note Tier 2 skipped: rebuild is a no-op (fixed point)"), m;
  const k = y.children.map((P) => so(P));
...
const Kg = /* @__PURE__ */ new Set(["ca", "cp"]), Al = "cp";
function jg(e) {
  if (!ur(e)) return !1;
  const t = { text: "", spans: [], sentinels: [] };
  if (ns(e, t, cr, void 0), t.sentinels.length > 0) return !1;
  const r = t.text;
  if (r.trim() === "") return !1;
  const n = Sr(r, { getMarker: cr }), [i] = n, s = n.length === 1 && typeof i == "object" && i.type === "para" && i.marker === "p" && !/^\s*\\p\s/.test(r) ? i.content ?? [] : n;
  return s.length === 0 ? !1 : s.every(
    (o) => typeof o == "string" ? o.trim() === "" : (o.type === "char" || o.type === "para") && (o.marker === "ca" || o.marker === Al)
  );
}
function No(e) {
  const t = [];
...
function tE(e, t) {
  ...
  const p = f.root.children.map((g) => so(g));
  return $e(p[0]) ? (p.forEach((g) => e.insertBefore(g)), s.forEach((g) => g.remove()), Dg(p, a, c, n, r), !0) : (i?.warn("[MarkerEdit] Chapter Tier 2 aborted: serialized output is not a chapter"), !1);
}
function ss(e) {
  let t, r;
  for (let n = e; n; n = n.getParent()) {
    if (Le(n)) return;
    !t && (K(n) || ae(n) || $e(n)) && (t = n), My(n.getParent()) && (r = n);
  }
  return t && !t.is(r) ? t : (r ? eE(r) : void 0) ?? t;
}
function jt(e, t, r) {
  const n = ss(e);
  return n ? K(n) ? ZM(n, t) : $e(n) ? tE(n, t) : Ug([n], t, r) : !1;
}
    ...
    for (const r of e) {
      ...
      switch (r.type) {
        ...
        case "chapter":
          ...
          break;
        case "ms":
          t.push(`\\${n}`), Ld(r, t), t.push("\\*");
          break;
        case "unmatched":
          t.push(`\\${n}`);
          break;
        case "char":
          t.push(`\\${n} `), ws(r.content, t), Ld(r, t), i !== "false" && t.push(`\\${n}*`);
          break;
        case "note": {
...
function Nl(e) {
  const t = iE(e);
  e.splice(0, 0, nE(e.getMarker())), t && Pl(e);
}
function ro(e, t) {
...
function oE(e) {
  ...
  return [...i].filter((s) => {
    ...
    return !(o && !Ud(r, s, "start") || a && !Ud(n, s, "end"));
  });
}
function nc(e) {
...
function cE(e) {
  const t = R();
  !O(t) || t.isCollapsed() || t.getNodes().some((r) => N(r)) && (nc(e), t.removeText());
}
function lE(e, t) {
...
function fE(e, t) {
  ...
  if (e.getIsCollapsed() !== !0) {
    ...
    const s = e.getCaller(), o = s !== "" && r.some(
      (c) => v(c) && !N(c) && c.getTextContent() === Mt(s)
    ), a = ci(e).some(({ node: c }) => N(c));
    if (!o && !a) return;
    r.forEach((c) => {
      N(c) || (v(c) && c.getTextContent() === Mt(s) && c.setTextContent(` ${s} `), e.insertBefore(c));
...
function Vg(e, t, r) {
  if (!N(e.getFirstChild()) && r?.markerMode === "editable" && pi(r)) {
    ro(e, t);
    return;
  }
  Ah(e, t);
...
function ic() {
  ...
  return i.getChildren().every(N) && i.append(pe(Dt)), Jg(i), !0;
}
function Jg(e) {
  const t = e.getChildren().find((r) => !N(r));
  if (v(t)) {
...
function PE() {
  const [e] = ce();
  return j(() => e.registerCommand(kf, () => !0, yt), [e]), null;
}
function NE(e, t) {
  if (!e.startsWith("\\")) return !0;
  const r = UM.exec(e)?.[1];
  return r === void 0 ? !1 : !xl(r, t);
}
function Qg(e, t) {
...
function tm(e, t, r) {
  ...
  if (ae(i)) {
    ...
    const s = e.getMarker();
    return i.setMarker(t), e.setMarker(t), jd(s, t) && Kd(e, n), r.logger?.debug(`[MarkerEdit] para marker renamed to "${t}"`), !0;
  }
  if (D(i) || K(i)) {
    const s = t.replace(/^\+/, "");
    ...
    return c && (OE(c, rt(s, c.getNested()).length), c.setMarker(s)), e.setMarker(s), jd(a, s) && Kd(e, n), r.logger?.debug(`[MarkerEdit] ${i.getType()} marker renamed to "${s}"`), !0;
  }
  return jt(e, r);
}
function RE(e) {
...
function $E(e, t) {
  ...
  if (e.getMarkerSyntax() === "closing") {
    ...
    if (D(n) && e.getMarker() === n.getMarker() && n.getLastChild()?.is(e) && r.startsWith(i) && r.length > i.length) {
      const s = R(), o = O(s) && s.isCollapsed() && s.anchor.key === e.getKey() && s.anchor.offset > i.length ? s.anchor.offset - i.length : void 0, a = pe(r.slice(i.length));
...
function DE(e, t) {
  ...
  if (t.pendingKeys.delete(e.getKey()), Bd.test(a ?? "")) {
    o !== e.getNumber() && e.setNumber(o);
    return;
  }
  e.setNumber(o), e.setTextContent(Lt("v", o)), a && Vd(e, a, a.length);
}
const UE = /^[ \u00A0]+([^ \u00A0\\]+)[ \u00A0]+$/;
function FE(e, t) {
  const r = e.getParent();
  if (!K(r) || r.getIsCollapsed() !== !1 || !Of(r.getMarker())?.includes("caller")) return !1;
  const n = r.getChildren();
  let i = 0;
  for (; i < n.length; ) {
    const c = n[i];
...
function jE(e, t, r = "departure") {
  ...
  for (const l of Yi)
    if (l.settleScope !== "none" && l.ownerPredicate(e) && hs(l, e) && (i || KE(e)))
      return t.pendingKeys.add(e.getKey()), { handled: !0, mutated: !1 };
  for (const l of nm(e))
    l.remove(), n = !0;
  let s = !1;
  ...
  for (const l of Yi)
    if (l.settleScope !== "none" && l.ownerPredicate(e)) {
      ...
      if (l.deletionPolicy === "remove-owner" && Zp(l, e))
...
function Es(e, t, r = "departure") {
  ...
  for (const a of s) {
    ...
    if (N(c)) {
      ...
      if (Xr(c)) continue;
      const g = Eg.exec(p);
      c.getMarkerSyntax() === "opening" && g ? n = tm(c, g[1], e) || n : r === "idle" && Dd(c, e.getMarker, e.viewOptions) ? e.pendingKeys.add(a) : Zg(c, e) ? (n = !0, e.logger?.debug(
...
function WE(e, t) {
  ...
  if (!r.includes("\\")) {
    if (r.includes("|") && im(e)) t.pendingKeys.add(e.getKey());
      ...
      t.pendingKeys.add(e.getKey());
    else if (Rp(e)) t.pendingKeys.add(e.getKey());
    else if ($e(ss(e))) t.pendingKeys.add(e.getKey());
    else {
      const a = e.getParent();
      D(a) && Lp(a) && t.pendingKeys.add(a.getKey()), t.pendingKeys.delete(e.getKey());
    }
    return;
  }
  if (Gd(e)) return;
...
function HE(e, t) {
  return e.deletionPolicy !== "remove-owner" || e.byteFormat.writer !== "read-only" ? !1 : Zp(e, t);
}
function GE(e) {
  const t = (r) => {
    if (N(r)) {
    ...
    if (Qr(r)) {
      Bp(r) || e.pendingKeys.add(r.getKey());
      return;
    }
    for (const n of Yi)
      n.settleScope !== "none" && n.ownerPredicate(r) && (hs(n, r) || HE(n, r)) && e.pendingKeys.add(r.getKey());
    if (Pe(r)) {
    ...
    if (v(r)) {
      ...
      (i.includes("\\") || i.includes("|") && im(r) || i.includes("//") || Rp(r) !== void 0) && e.pendingKeys.add(r.getKey());
      return;
    }
    if (D(r)) {
...
function ZE(e) {
  return e.startsWith(sc) ? QE(e.slice(sc.length)).replaceAll(`
`, " ") : "";
}
function sm(e) {
...
function oc(e) {
  ...
  if (!t) return;
  const r = (a) => a.replace(/\r\n?/g, `
`), n = r(t.getData("text/plain")), i = t.getData("text/html"), s = i ? r(iA(i)) : "", o = i ? rA(i) : void 0;
  return {
    text: o !== void 0 ? r(o) : n || s,
    isInternal: !!t.getData("application/x-lexical-editor")
  };
}
const am = String.raw`\\(?:\+?[${Xt}]+\*?|\*)`, sA = new RegExp(String.raw`(${am})\u00A0`, "g"), oA = new RegExp(String.raw`\u00A0(?=${am})`, "g");
function Ol(e) {
  return e.replace(/^\u00A0/gm, " ").replace(sA, "$1 ").replace(oA, "").replaceAll(L, "~");
}
const aA = new RegExp(
  String.raw`\\c(?![${Xt}])[ \u00A0]*[^\s\\]*`,
  "g"
), cA = new RegExp(String.raw`\\id(?![${Xt}])[^\n\\]*`, "g");
function wl(e) {
  return e.split(`
`).map((t) => {
    const r = t.replace(aA, "").replace(cA, "");
    return r === "" && t !== "" ? void 0 : r;
...
function fA(e, t = !1, r = () => {
  ...
  const i = oc(e);
  if (!i) return !1;
  const s = R(), o = O(s) && lA(s);
  if (!o && i.isInternal || t && O(s) && Ns(s))
    return !1;
  const { text: a } = i;
  if (!a || !O(s)) return !1;
...
function pA(e) {
  ...
  const t = e.getParent();
  return K(t) ? !_t(e.getPreviousSibling()) : !1;
}
function hA(e, t) {
  if (t || e.getTextContent() !== L) return "";
  const r = e.getParent();
  if (!K(r) || !_t(e.getPreviousSibling())) return "";
  const n = r.getCategory();
  return n ? `\\cat ${n}\\cat*` : "";
}
function gA(e) {
  const t = e.getParent();
  return (K(t) ? t.getCaller() : void 0) || Ki;
}
function mA(e) {
  const t = e.getParent();
...
`), u = !d.isEmpty();
    ...
    if (u = !1, _t(d))
      (d !== n || !e.isCollapsed()) && (l += ` ${gA(d)}`);
    else if (v(d)) {
      let f = d.getTextContent();
      d === r ? d === n ? (i.type !== "element" || s.type !== "element" || s.offset === i.offset) && (f = a < c ? f.slice(a, c) : f.slice(c, a)) : f = o ? f.slice(a) : f.slice(c) : d === n && (f = o ? f.slice(0, c) : f.slice(0, a)), l += pA(d) ? "" : f.replaceAll(L, " ") + hA(d, d === n);
    } else (co(d) || cs(d)) && (d !== n || !e.isCollapsed()) && (l += d.getTextContent());
  }
  return l;
}
function bA(e) {
...
function Yd(e, t, r) {
  ...
  if (!e || !("clipboardData" in e))
    return Py(t, null, i), r && n.removeText(), !0;
...
function xA(e, t) {
  const r = (n, i) => {
    if (i.updateTags.has(xc) || i.updateTags.has(ji)) return;
    const s = [];
...
`);
          let c = Fd(a, t.getMarker);
          if (c === "declined" && gE(e) && (c = Fd(a, t.getMarker)), c === "handled")
...
function CA({
  ...
  const [s] = ce(), o = e?.markerMode === "editable", a = !!e && So(e), c = re(void 0), l = re(n);
  return j(() => {
    l.current = n;
    const u = c.current;
    ...
    let f, p = !1, g, y = !1, m = !1, k = 0;
    const _ = () => k < Xd ? !1 : (u.logger?.warn(
      `[MarkerEdit] settle cascade exceeded ${Xd} consecutive mutating passes; leaving ${u.pendingKeys.size} node(s) pending. This is a rebuild that never reaches a fixed point — pending keys: ${[...u.pendingKeys].join(", ")}`
    ), !0), S = (M, w = "departure") => {
      s.update(() => {
        k = ma(
          () => Es(u, M, w)
    ...
    const A = () => {
      ...
      const M = l.current ?? TA;
      M < 0 || (P = setTimeout(() => {
        P = void 0, !(m || u.pendingKeys.size === 0) && (p || _() || S(void 0, "idle"));
      }, M));
    }, B = He(
      s.registerNodeTransform(pr, (M) => {
        ...
        $E(M, u);
        const w = xn(M);
        w && (Pe(w.owner) || K(w.owner) || $e(w.owner) || Be(w.owner) && mo(w.owner).wrapper === void 0) && Vn(w.owner, u);
      }),
      ...
      s.registerUpdateListener(({ editorState: M, tags: w }) => {
        ...
        p || ($ !== void 0 && (f = $), A(), !(y || $ === void 0) && [...u.pendingKeys].some((J) => J !== $) && (y = !0, queueMicrotask(() => {
          y = !1, !m && (_() || S(f));
        })));
      })
    );
    return () => {
      m = !0, P !== void 0 && clearTimeout(P), P = void 0, d(), B(), c.current = void 0;
    };
  }, [s, o, a]), null;
}
const SA = ["status_unknown", "status_invalid"], lm = {
...
function Qd(e) {
  e.classList.remove(...SA), e.removeAttribute("aria-description"), vA.includes(e.title) && e.removeAttribute("title");
}
function EA(e, t, r, n) {
...
function OA(e, t, r, n, i) {
  ...
  const l = i ? Rl(c, i) : c.text, u = Sr(l, {
    getMarker: o
  });
  ...
  if (yi(d, o) === mi(e, o) && ql(e, d, o)) {
    a?.debug("[MarkerEdit] Settled USJ skipped: rebuild is a no-op (fixed point)");
    return;
  }
  dm(d, f);
  const g = wA(e), y = gm(d);
  for (let m = 0; m < g.length && m < y.length; m++)
    g[m].sid !== void 0 && y[m].number === g[m].number && (y[m].sid = g[m].sid);
  return d;
}
function wA(e) {
  const t = [], r = (n) => {
...
function qA(e, t, r, n, i) {
  ...
  if (u.length === 0) return;
  const d = i ? Rl(l, i) : l.text, f = Sr(d, {
    getMarker: o,
    isNoteContext: !0
  });
  ...
  const g = p.content ?? [], y = zg(g), m = e.getCategory() !== y, k = Pg(e, g, y, s);
  if (k.failure !== void 0) {
  ...
  if (yi(_, o) === mi(u, o) && ql(u, _, o)) {
    if (m)
      return { rebuilt: void 0, contentNodes: u, category: y, categoryChanged: m };
    a?.debug("[MarkerEdit] Settled note USJ skipped: rebuild is a no-op (fixed point)");
    return;
  }
  return dm(_, S), { rebuilt: _, contentNodes: u, category: y, categoryChanged: m };
}
function Zd(e) {
  return e.$?.textType;
}
...
function DA(e, t, r) {
  ...
  if (!o) return;
  const a = r ? Rl(o, r) : o.text, c = Sr(a, {
    getMarker: i
  }), [l] = c;
  ...
  if (u.length === 0) return;
  const d = [e, ...No(e)];
  if (!(e.getNumber() !== (l.number ?? "") || e.getAltnumber() !== l.altnumber || e.getPubnumber() !== l.pubnumber) && yi(u, i) === mi(d, i) && ql(d, u, i)) {
...
function UA(e, t, r, n, i) {
  ...
  const o = /* @__PURE__ */ new Map(), a = [], c = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), d = (m) => {
    K(m) ? c.set(m.getKey(), m) : $e(m) ? l.set(m.getKey(), m) : o.set(m.getKey(), [m]);
  };
  for (const m of t) {
    const k = se(m);
  ...
  for (const m of a)
    m.some((k) => f.has(k.getKey())) || (m.forEach((k) => {
  ...
  if (o.size === 0 && c.size === 0 && l.size === 0 && p.length === 0)
    return;
  const g = new Set(p.map((m) => m.getKey())), y = /* @__PURE__ */ new Map();
  um(Ue().getChildren(), e.root.children, y);
  for (const m of u.values()) LA(m, y);
  for (const m of c.values()) {
    const k = y.get(m.getKey()), _ = k ? _r(k.node) : void 0;
    if (!k || !_) continue;
    const S = qA(m, y, r, g, s);
    if (!S) continue;
  ...
  for (const m of o.values()) {
    const k = y.get(m[0].getKey());
    if (!k) continue;
    const _ = OA(m, y, r, g, s);
    if (!_) continue;
    const S = k.siblings.indexOf(k.node);
    S < 0 || k.siblings.splice(S, m.length, ..._);
  }
  for (const m of l.values()) {
    const k = y.get(m.getKey());
    if (!k) continue;
    const _ = 1 + No(m).length, S = DA(m, r, s);
    if (!S) continue;
  ...
  for (const m of p) {
    ...
    const S = k.siblings[_ - 1], P = k.siblings[_], A = S && oi(S), B = P && oi(P);
    S && P && A !== void 0 && B !== void 0 && RA(S, P) && (S.text = A + B, k.siblings.splice(_, 1));
  }
...
function FA({
  ...
  const [r] = ce(), n = pi(e) && (e?.markerMode === "visible" || (e?.hasGutterParaMarkers ?? !1));
  return j(() => {
    if (n)
...
function mm(e, t) {
  const r = qc(R()), n = Jc(r)?.getNumber(), i = hp(r);
  if ((i ? parseInt(i.getNumber() ?? "1", 10) : 1) === e && n && (Tp(n) ? bm(t, n) : parseInt(n, 10) === t))
    return;
  const o = Ue().getChildren(), a = pp(o, e);
  if (!a) return;
  ...
  u && (ae(u) ? !v(u.getFirstChild()) && gi(u) || Jt(u, 0) : WA(u));
}
function WA(e) {
  const t = e.getParent();
  if (!t) return;
  ...
  const s = F(n) && !K(n) ? ym(n) : void 0;
  s ? s.select(0, 0) : Jt(t, r);
}
function ym(e) {
  const t = e.getFirstChild();
  if (v(t)) return t;
  if (F(t) && !K(t)) return ym(t);
}
function As(e) {
  return e.read(() => {
...
function HA(e, t) {
  e.phase !== "navigating" && t && (GA(t, e.scrRef) || km(e, JA(t, e.scrRef)));
}
function GA(e, t) {
...
const YA = 8;
function km(e, t) {
  return no(t, e.scrRef) || e.pendingEchoes.some((r) => no(r, t)) ? !1 : (e.pendingEchoes.push(t), e.pendingEchoes.length > YA && e.pendingEchoes.shift(), e.onScrRefChange(t), !0);
}
function no(e, t) {
...
function QA(e) {
  return Tt(e) ? `${e.__code}` : $e(e) ? `${e.__marker} "${e.__number}"` : D(e) ? `${e.__marker}` : ds(e) ? `${e.__marker} "${e.__number}"` : _t(e) ? `${e.__caller}` : On(e) ? `${e.__marker} "${e.__number}"` : K(e) ? `${e.__marker} "${e.__caller}"` + (e.__isCollapsed ? " (collapsed)" : " (expanded)") : ae(e) ? `${e.__marker}` : v(e) ? `"${e.__text}"${ZA(e)}` : Ce(e) ? `ids: [ ${JSON.stringify(e.getTypedIDs())} ]` : Pe(e) ? `${e.__marker} "${e.__number}"` : "";
}
function ZA(e) {
...
function n1({
  ...
  return j(() => {
    ...
    if (l && f !== null && p !== null) {
      const { top: g, left: y } = f.getBoundingClientRect();
      p.style.top = `${g + f.offsetHeight + rf}px`, p.style.left = `${Math.min(y, window.innerWidth - p.offsetWidth - 20)}px`;
    }
  }, [a, c, l]), j(() => {
    const f = c.current;
    if (f !== null && l) {
    ...
    const f = () => {
      if (l) {
        ...
        if (p !== null && g !== null) {
          const { top: y } = p.getBoundingClientRect(), m = y + p.offsetHeight + rf;
    ...
    l && hn(
      /* @__PURE__ */ C(r1, { dropDownRef: a, onClose: d, children: s }),
      document.body
    )
  ] });
}
  ...
  return /* @__PURE__ */ C(
    n1,
    {
      ...
      children: Object.keys(lc).map((n) => /* @__PURE__ */ xe(
        t1,
        {
          className: "item block-marker " + a1(t === n),
...
const c1 = Mn(function({ editorRef: t, isReadonly: r = !1, onStateChange: n }, i) {
...
const xm = Mn(function({
  ...
  const d = re(null), f = re(null), p = re(null), g = re(t), y = re(void 0), m = re(void 0), k = re(void 0), _ = re(void 0), S = re(!1), [P, A] = de(t), [B, M] = de(0), [w, $] = de(), {
    isReadonly: X = !1,
  ...
  } = a ?? d1, E = Qt ?? l1, Y = ts(E) && (E.markerMode !== "hidden" || !E.hasSpacing || E.hasGutterParaMarkers || E.hasActiveTextFocusBox) ? {
    ...E,
    markerMode: "hidden",
    hasSpacing: !0,
    hasGutterParaMarkers: !1,
  ...
  const W = le.current, ke = Fe(() => we ?? u1, [we]), Nt = Fe(() => hr, [hr]), Nr = Fe(
    () => FT(Ct ?? Bs),
    [Ct]
  ), Zt = re(c);
  wt(Zt.current, c) || (Zt.current = c);
  const Je = Zt.current, ct = ts(W), ue = X || ct, qn = Y !== E;
  j(() => {
    ct && !X && Je?.error(
  ...
  const tn = he(() => {
    ...
    const z = vu(q), G = m.current;
    if ((!z || z.size === 0) && !G) return g.current;
    ...
    setTransientInput(q) {
      ...
      m.current = { input: q, nodeKey: z ?? k.current?.key };
    },
    setUsj(q) {
      if (!wt(g.current, q)) {
        g.current = q, m.current = void 0;
        const z = wt(P, q);
        A(q), z && M((G) => G + 1);
      }
    },
    applyUpdate(q, z = "remote") {
      ...
      if (Q) {
        const _e = !wt(g.current, Q);
        if (_e && (g.current = Q), _e || !wt(P, Q)) {
          const lt = Lu(q, G, "apply");
          _.current = Q, s?.(Q, q, z, lt);
        }
      }
    },
    replaceEmbedUpdate(q, z) {
      const G = d.current?.read(() => fx(q, z));
    ...
    removeAnnotation(q, z) {
      f.current?.removeAnnotation(pu(q), z);
    },
    formatPara(q) {
    ...
    selectNote(q) {
      d.current?.update(() => {
        const z = ju(q);
        z && (Jx(z, W), z.getIsCollapsed() || (y.current = z.getKey()));
      });
    },
    getNoteOps(q) {
      return d.current?.read(() => {
  ...
  const gs = he(
    (q, z, G, Q) => {
      ...
      if (_e) {
        const lt = !wt(g.current, _e);
        if (lt && (g.current = _e), lt || !wt(P, _e)) {
          const Ot = Lu(Q, q);
  ...
  j(() => {
    ...
    if (!(!q || !s))
      return q.registerUpdateListener(({ tags: z, dirtyElements: G, dirtyLeaves: Q }) => {
        !z.has(xc) && (G.size === 0 && Q.size === 0 || z.has(ji) || !vu(q)?.size) || queueMicrotask(() => {
          const _e = tn();
  ...
  return (
    ...
    /* @__PURE__ */ xe(vf, { initialConfig: er, children: [
        ...
        /* @__PURE__ */ xe("div", { className: "editor-inner", children: [
          ...
          /* @__PURE__ */ C(
            qy,
            {
              ...
              placeholder: /* @__PURE__ */ C(f1, {}),
              ErrorBoundary: Af
            }
          ),
          Me && /* @__PURE__ */ C(AC, {}),
          /* @__PURE__ */ C(Pf, {}),
          r && n && /* @__PURE__ */ C(KA, { scrRef: r, onScrRefChange: n }),
          r && !Me && /* @__PURE__ */ C(
            ZS,
            {
              trigger: be,
          ...
          /* @__PURE__ */ C(W_, {}),
          /* @__PURE__ */ C(K_, {}),
          /* @__PURE__ */ C(FA, { viewOptions: W, logger: Je }),
          /* @__PURE__ */ C(ZC, {}),
      ...
      if (c.origin !== this) {
        for (const l of a)
          if (l instanceof Yy) {
            ...
            let f = 0;
            for (const p of d) {
              const g = p.insert, y = p.retain, m = p.delete, k = u.parent, _ = u === r ? void 0 : k instanceof ru && this._comments.find((S) => S.id === k.get("id"));
              if (Array.isArray(g)) {
                const S = f;
...
function Sm() {
  const [e, t] = de(null), r = he(() => {
    ...
    return /* @__PURE__ */ C(y1, { onClose: r, title: s, closeOnClickOutside: a, children: o });
  }, [e, r]), i = he(
    (s, o, a = !1) => {
      t({
...
function T1({
  ...
  return /* @__PURE__ */ C(Mf, { className: e || "ContentEditable__root" });
}
function x1({
  children: e,
  className: t
...
const of = Tf("INSERT_INLINE_COMMAND");
function _1({
  anchorKey: e,
  editor: t,
  showComments: r,
...
function vm({
  ...
  return /* @__PURE__ */ C(vf, { initialConfig: {
    ...
    /* @__PURE__ */ C(
      Wy,
      {
        contentEditable: /* @__PURE__ */ C(T1, { className: e }),
        placeholder: /* @__PURE__ */ C(x1, { children: s }),
        ErrorBoundary: Af
      }
    ),
    ...
    /* @__PURE__ */ C(Pf, {}),
    t !== !1 && /* @__PURE__ */ C(Ky, {}),
    /* @__PURE__ */ C(C1, { onEscape: r }),
    /* @__PURE__ */ C(jy, {}),
    i !== void 0 && /* @__PURE__ */ C(Ef, { editorRef: i })
  ] }) });
}
function Mm(e, t) {
  return he(
...
function S1({
  ...
  const [n, i] = de(""), [s, o] = de(!1), a = re(null), c = Fe(
    ...
    e.getEditorState().read(() => {
      ...
      if (O(y)) {
        l.current = y.clone();
        const m = y.anchor, k = y.focus, _ = $y(
          e,
          m.getNode(),
          m.offset,
          k.getNode(),
...
function v1({
  ...
  const [n, i] = de(""), [s, o] = de(!1), a = re(null), c = Am(), l = Mm(i, o);
...
function A1({
  ...
  const o = Nf(), [a] = ce(), c = Fe(() => {
    const w = new h1(a, s);
    return r && w.registerOnChange(r), t?.(w), w;
  }, [a, s, r, t]), l = g1(c), u = Fe(() => /* @__PURE__ */ new Map(), []), [d, f] = de(), [p, g] = de([]), [y, m] = de(!1), [k, _] = de(!1), { yjsDocMap: S } = o;
  j(() => {
    if (e) {
      ...
      if (w.type === "comment") {
        ...
        J !== void 0 && setTimeout(() => {
          a.update(() => {
            for (const Me of J) {
              const ee = se(Me);
              Ce(ee) && (ee.deleteID(zr, X), ee.hasNoIDsForEveryType() && Ds(ee));
            }
          });
        });
      }
    ...
    for (const X of p) {
      ...
      if (J !== void 0)
        for (const Me of J) {
          ...
          ee !== null && (ee.classList.add("selected"), w.push(ee), $ = window.setTimeout(() => {
            _(!0);
          }, 0));
        }
    }
        ...
        $.read(() => {
          ...
          if (O(J)) {
            ...
            if (v(Oe)) {
              ...
              be !== null && (g(be), Me = !0), J.isCollapsed() || (f(Oe.getKey()), ee = !0);
            }
          }
          Me || g((Oe) => Oe.length === 0 ? Oe : []), ee || f(null), !X.has("collaboration") && O(J) && m(!1);
        });
      }),
      a.registerCommand(
        of,
...
const kP = Mn(function(t, r) {
  const n = re(null), i = re(!0), s = re(null), [o, a] = de(null), { children: c, onCommentChange: l, onUsjChange: u, showCommentsContainerRef: d, ...f } = t, { logger: p, options: { isReadonly: g, view: y } = {} } = t, m = (g ?? !1) || ts(y), [k, _] = P1();
  O1(f, k), j(() => {
  ...
  return j(() => (a(n.current?.toolbarEndRef ?? null), () => a(null)), []), /* @__PURE__ */ C(By, { children: /* @__PURE__ */ xe(xm, { ref: n, onUsjChange: S, ...f, children: [
    /* @__PURE__ */ C(
      A1,
      {
        setCommentStore: _,
...
const R1 = {
  ...
  left: "right",
  right: "left"
}, dc = ".editor-input.usfm", I1 = /^[\w.#[\]="':()>+~*,\s-]+$/;
function L1(e) {
  return I1.test(e) ? e : (console.warn(
    `[generateUsjCss] Ignoring unsafe containerSelector "${e}"; using "${dc}".`
  ), dc);
}
function D1(e, t, r, n) {
  const i = [];
  if (t.fontName && i.push(`font-family: "${Pm(t.fontName)}"`), t.bold && i.push("font-weight: bold"), t.italic && i.push("font-style: italic"), t.color && (q1.test(t.color) ? i.push(`color: ${t.color}`) : console.warn(
    ...
    const s = R1[n ? $1[t.justification] ?? t.justification : t.justification];
...
function TP(e, t = {}) {
  const { zoom: r = 1, rtl: n = !1, containerSelector: i = dc } = t, s = L1(i), o = [], a = [];
  ...
  for (const [c, l] of Object.entries(e.markers)) {
    const u = D1(c, l, r, n);
    u.length > 0 && o.push(`${s} .usfm_${w1(c)} { ${u.join("; ")}; }`);
  }
...
export {
  ...
  T as CategoryType,
  bP as Editorial,
  Ki as GENERATOR_NOTE_CALLER,
  wf as HIDDEN_NOTE_CALLER,
  kP as Marginal,
  b as MarkerType,
  Sh as PARAGRAPH_STRUCTURE_VIEW_MODE,
  vh as STANDARD_VIEW_MODE,
